...
internal object MetadataStorageImpl : MetadataStorageBase() {
      ...
      properties = listOf(
        ...
        OwnPropertyMetadata(
          ...
          valueType = ValueTypeMetadata.SimpleType.CustomType(
            isNullable = false,
            typeMetadata = FinalClassMetadata.ClassMetadata(
              fqName = "org.jetbrains.bazel.workspacemodel.entities.WorkspaceModelTargetSourceRootTypeId",
              properties = listOf(
                OwnPropertyMetadata(
                  isComputable = false,
                  isKey = false,
  ...
  override fun initializeMetadataHash() {
    ...
    addMetadataHash(
      typeFqn = "com.intellij.platform.workspace.jps.entities.LibraryTableId\$ModuleLibraryTableId",
    ...
    addMetadataHash(typeFqn = "com.intellij.platform.workspace.storage.SymbolicEntityId", metadataHash = 1804943590)
  }
}
