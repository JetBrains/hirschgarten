...
internal object MetadataStorageImpl : MetadataStorageBase() {
  override fun initializeMetadata() {
    ...
    typeMetadata = EntityMetadata(
      fqName = "org.jetbrains.bazel.workspacemodel.entities.AbstractBazelProjectDirectoriesEntity",
  ...
  override fun initializeMetadataHash() {
    addMetadataHash(
      typeFqn = "org.jetbrains.bazel.workspacemodel.entities.AbstractBazelProjectDirectoriesEntity",
