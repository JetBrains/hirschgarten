...
object BazelTestLocationHintProvider {
  ...
  fun testLocationHint(name: String, classname: String?, parentSuites: List<String>, isSuite: Boolean): String =
    when (isSuite) {
   ...
   */
  fun testCaseLocationHint(testName: String, classname: String? = null, parentSuites: List<String> = emptyList()): String {
   ...
   * If non-null `classname` is given, `parentSuites` is ignored - it serves as a fallback if `classname` is unknown
   */
  fun testSuiteLocationHint(suiteName: String, classname: String? = null, parentSuites: List<String> = emptyList()): String {
    val classnameToUse = when {
   ...
   */
  data class LocationHintData(
    val classNameOrSuites: List<String>,
