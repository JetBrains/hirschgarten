...
class GenericBlazeRules : TargetKind.Provider {
    /** Generic blaze rule types.  */
    enum class RuleTypes(val ruleName: String, val languageClass: LanguageClass, val ruleType: RuleType) {
