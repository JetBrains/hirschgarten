...
import org.jetbrains.bazel.languages.projectview.IMPORT_IJARS_KEY
import org.jetbrains.bazel.languages.projectview.sections.presets.BooleanScalarSection

internal class ImportIjarsSection : BooleanScalarSection() {
  override val sectionKey = IMPORT_IJARS_KEY
