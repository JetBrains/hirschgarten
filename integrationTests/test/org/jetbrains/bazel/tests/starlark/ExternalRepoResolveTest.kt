...
/**
 * ```sh
 * bazel test //plugins/bazel/integrationTests:integrationTests_test --test_env=JB_TEST_FILTER=org.jetbrains.bazel.tests.starlark.ExternalRepoResolveTest --test_output=errors --nocache_test_results
 * ```
 */
