...
/**
 * ```sh
 * bazel test //plugins/bazel/integrationTests:integrationTests_test --test_env=JB_TEST_FILTER=org.jetbrains.bazel.tests.java.CompiledSourceCodeInsideJarExcludeTest --test_output=errors --nocache_test_results
 * ```
 */
