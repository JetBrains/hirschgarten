...
private class HotSwapTask(
  ...
  override suspend fun preRun() {
    ...
    val key = HotSwapUIImpl::class.java.getDeclaredField("HOT_SWAP_CALLBACK_KEY")
      .apply { isAccessible = true }
      .get(null) as Key<HotSwapStatusListener>
    val listener = projectTaskContext.getUserData(key)
