...
interface BazelBuildServer {
  ...
  @JsonRequest("workspace/buildTargetsFirstStep")
  fun workspaceBuildTargetsFirstStep(params: WorkspaceBuildTargetsFirstStepParams): CompletableFuture<WorkspaceBuildTargetsResult>
}
