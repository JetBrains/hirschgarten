...
internal class ScalaAddendumEntityImpl(private val dataSource: ScalaAddendumEntityData): ScalaAddendumEntity, WorkspaceEntityBase(dataSource) {

private companion object {
internal val MODULE_CONNECTION_ID: ConnectionId = ConnectionId.create(ModuleEntity::class.java, ScalaAddendumEntity::class.java, ConnectionId.ConnectionType.ONE_TO_ONE, false)
...
get() = snapshot.instrumentation.getParent(MODULE_CONNECTION_ID, this) as? ModuleEntity ?: error("Parent module not found for ScalaAddendumEntity")
...
internal class Builder(result: ScalaAddendumEntityData?): ModifiableWorkspaceEntityBase<ScalaAddendumEntity, ScalaAddendumEntityData>(result), ScalaAddendumEntityBuilder {
...
((_diff as MutableEntityStorageInstrumentation).getParentBuilder(MODULE_CONNECTION_ID, this) as? ModuleEntityBuilder) ?: (this.entityLinks[EntityLink(false, MODULE_CONNECTION_ID)] as? ModuleEntityBuilder) ?: error("module is null for ScalaAddendumEntity")
} else {
(this.entityLinks[EntityLink(false, MODULE_CONNECTION_ID)] as? ModuleEntityBuilder) ?: error("module is null for ScalaAddendumEntity")
}
}
set(value){
checkModificationAllowed()
