...
internal class BazelGoTargetEntityData : WorkspaceEntityData<BazelGoTargetEntity>(), SoftLinkable {
  ...
  override fun newInstance(): BazelGoTargetEntity = BazelGoTargetEntityImpl(this)
  override fun newBuilderInstance(): ModifiableWorkspaceEntityBase<BazelGoTargetEntity, *> = BazelGoTargetEntityImpl.Builder(null)
