...
internal class JvmBinaryJarsEntityImpl(private val dataSource: JvmBinaryJarsEntityData) : JvmBinaryJarsEntity,
  ...
  internal class Builder(result: JvmBinaryJarsEntityData?) :
    ...
    override var module: ModuleEntityBuilder
      get() = getParent(MODULE_CONNECTION_ID) as? ModuleEntityBuilder ?: error("module is null for JvmBinaryJarsEntity")
      set(value) {
...
internal class JvmBinaryJarsEntityData : WorkspaceEntityData<JvmBinaryJarsEntity>() {
  ...
  override fun newInstance(): JvmBinaryJarsEntity = JvmBinaryJarsEntityImpl(this)
  override fun newBuilderInstance(): ModifiableWorkspaceEntityBase<JvmBinaryJarsEntity, *> = JvmBinaryJarsEntityImpl.Builder(null)
