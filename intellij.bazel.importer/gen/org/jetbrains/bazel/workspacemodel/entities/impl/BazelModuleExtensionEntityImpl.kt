...
internal class BazelModuleExtensionEntityImpl(private val dataSource: BazelModuleExtensionEntityData): BazelModuleExtensionEntity, WorkspaceEntityBase(dataSource) {

private companion object {
internal val MODULE_CONNECTION_ID: ConnectionId = ConnectionId.create(ModuleEntity::class.java, BazelModuleExtensionEntity::class.java, ConnectionId.ConnectionType.ONE_TO_ONE, false)
private val connections = listOf<ConnectionId>(MODULE_CONNECTION_ID)

}

override val module: ModuleEntity
get() = snapshot.instrumentation.getParent(MODULE_CONNECTION_ID, this) as? ModuleEntity ?: error("Parent module not found for BazelModuleExtensionEntity")           
...
internal class Builder(result: BazelModuleExtensionEntityData?): ModifiableWorkspaceEntityBase<BazelModuleExtensionEntity, BazelModuleExtensionEntityData>(result), BazelModuleExtensionEntityBuilder {
...
((_diff as MutableEntityStorageInstrumentation).getParentBuilder(MODULE_CONNECTION_ID, this) as? ModuleEntityBuilder) ?: (this.entityLinks[EntityLink(false, MODULE_CONNECTION_ID)] as? ModuleEntityBuilder) ?: error("module is null for BazelModuleExtensionEntity")
} else {
(this.entityLinks[EntityLink(false, MODULE_CONNECTION_ID)] as? ModuleEntityBuilder) ?: error("module is null for BazelModuleExtensionEntity")
}
}
set(value){
checkModificationAllowed()
