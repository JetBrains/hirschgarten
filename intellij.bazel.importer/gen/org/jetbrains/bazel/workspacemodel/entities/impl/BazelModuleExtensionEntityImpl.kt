  ...
  internal class Builder(result: BazelModuleExtensionEntityData?) :
    ...
    override fun checkInitialization() {
      ...
      if (!getEntityData().is_targetKeyInitialized()) {
        error("Field BazelModuleExtensionEntity#_targetKey should be initialized")
      }
    ...
    override var module: ModuleEntityBuilder
      get() = getParent(MODULE_CONNECTION_ID) as? ModuleEntityBuilder ?: error("module is null for BazelModuleExtensionEntity")
      set(value) {
...
internal class BazelModuleExtensionEntityData : WorkspaceEntityData<BazelModuleExtensionEntity>() {
  ...
  override fun newInstance(): BazelModuleExtensionEntity = BazelModuleExtensionEntityImpl(this)
  override fun newBuilderInstance(): ModifiableWorkspaceEntityBase<BazelModuleExtensionEntity, *> =
    BazelModuleExtensionEntityImpl.Builder(null)
  ...
  override fun createDetachedEntity(parents: List<WorkspaceEntityBuilder<*>>): WorkspaceEntityBuilder<*> {
    return BazelModuleExtensionEntity(_targetKey, rootTypeId, strictDependencies, entitySource) {
