package runner;// Copyright 2000-2025 JetBrains s.r.o. and contributors. Use of this source code is governed by the Apache 2.0 license.
...
public final class JUnit5BazelRunner {
  ...
  public static void main(String[] args) throws IOException {
    try {
      ...
      // See: com.intellij.tests.runner.JUnit5BazelRunner.xmlReportBucketingTestsFilteringOut
  ...
  public static Set<Path> getClassPathRoots(ClassLoader classLoader) throws Throwable {
    // Adapted for the IDE starter test
    return Collections.singleton(Paths.get(JUnit5BazelRunner.class.getProtectionDomain().getCodeSource().getLocation().toURI()));
  }
   ...
   * `runner.JUnit5BazelRunner` writes a minimal JUnit XML to `XML_OUTPUT_FILE`
