    ...
    BaseConfiguration.BaseBuildType(
        ...
        steps = {
          ...
          bazel {
            ...
            command = "run"
            targets =
                "//server/bspcli:bspcli /tmp/project_10 %system.teamcity.build.checkoutDir%/metrics.txt"
            param("toolPath", "/usr/local/bin")
          }
        })

object GitHub : Benchmark(vcsRoot = BaseConfiguration.GitHubVcs)

object Space : Benchmark(vcsRoot = BaseConfiguration.SpaceVcs)
