...
object CommonParams {
  ...
  val BazelCiSpecificArgs: String = " --config=nocacheupload --config:bes --test_output=errors --announce_rc --show_progress_rate_limit=30 --curses=yes --terminal_columns=140"
  val BazelCiBuildSpecificArgs: String = "--config:bes --test_output=errors --announce_rc --show_progress_rate_limit=30 --curses=yes --terminal_columns=140"
