load("//:versions.bzl", "CL_BENCHMARK_BUILD_NUMBER", "IC_BENCHMARK_BUILD_NUMBER", "PY_BENCHMARK_BUILD_NUMBER")
...
_SUPPORTED_IDES = (IDE_ID.IC, IDE_ID.PY, IDE_ID.CL)

_IDE_ID_TO_BUILD_NUMBER = {
    IDE_ID.IC: IC_BENCHMARK_BUILD_NUMBER,
    IDE_ID.PY: PY_BENCHMARK_BUILD_NUMBER,
    IDE_ID.CL: CL_BENCHMARK_BUILD_NUMBER,
}
