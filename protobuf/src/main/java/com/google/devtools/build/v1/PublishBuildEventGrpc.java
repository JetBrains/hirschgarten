...
public final class PublishBuildEventGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.devtools.build.v1.PublishLifecycleEventRequest, com.google.protobuf.Empty>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            com.google.devtools.build.v1.PublishLifecycleEventRequest, com.google.protobuf.Empty>
        getPublishLifecycleEventMethod;
    if ((getPublishLifecycleEventMethod = PublishBuildEventGrpc.getPublishLifecycleEventMethod)
        == null) {
      synchronized (PublishBuildEventGrpc.class) {
        if ((getPublishLifecycleEventMethod = PublishBuildEventGrpc.getPublishLifecycleEventMethod)
            == null) {
          PublishBuildEventGrpc.getPublishLifecycleEventMethod =
              getPublishLifecycleEventMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "PublishLifecycleEvent"))
                      ...
                      .setSchemaDescriptor(
                          new PublishBuildEventMethodDescriptorSupplier("PublishLifecycleEvent"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.devtools.build.v1.PublishBuildToolEventStreamResponse>
        getPublishBuildToolEventStreamMethod;
    if ((getPublishBuildToolEventStreamMethod =
            PublishBuildEventGrpc.getPublishBuildToolEventStreamMethod)
        == null) {
      synchronized (PublishBuildEventGrpc.class) {
        if ((getPublishBuildToolEventStreamMethod =
                PublishBuildEventGrpc.getPublishBuildToolEventStreamMethod)
          ...
          PublishBuildEventGrpc.getPublishBuildToolEventStreamMethod =
              getPublishBuildToolEventStreamMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "PublishBuildToolEventStream"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.devtools.build.v1.PublishBuildToolEventStreamRequest
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.devtools.build.v1.PublishBuildToolEventStreamResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new PublishBuildEventMethodDescriptorSupplier(
  ...
  public static PublishBuildEventStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PublishBuildEventStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PublishBuildEventStub>() {
          @java.lang.Override
          public PublishBuildEventStub newStub(
   ...
   */
  public static PublishBuildEventBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PublishBuildEventBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PublishBuildEventBlockingStub>() {
          @java.lang.Override
          public PublishBuildEventBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static PublishBuildEventFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PublishBuildEventFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PublishBuildEventFutureStub>() {
          @java.lang.Override
          public PublishBuildEventFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default io.grpc.stub.StreamObserver<
      ...
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(
          getPublishBuildToolEventStreamMethod(), responseObserver);
    }
  }

  /** Base class for the server implementation of the service PublishBuildEvent. */
  public abstract static class PublishBuildEventImplBase
  ...
  public static final class PublishBuildEventStub
    ...
    private PublishBuildEventStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void publishLifecycleEvent(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPublishLifecycleEventMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public io.grpc.stub.StreamObserver<
      ...
      return io.grpc.stub.ClientCalls.asyncBidiStreamingCall(
          getChannel().newCall(getPublishBuildToolEventStreamMethod(), getCallOptions()),
          responseObserver);
    }
  }
  ...
  public static final class PublishBuildEventBlockingStub
    ...
    /** */
    public com.google.protobuf.Empty publishLifecycleEvent(
        com.google.devtools.build.v1.PublishLifecycleEventRequest request) {
  ...
  public static final class PublishBuildEventFutureStub
    ...
    private PublishBuildEventFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        publishLifecycleEvent(com.google.devtools.build.v1.PublishLifecycleEventRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PUBLISH_LIFECYCLE_EVENT:
          serviceImpl.publishLifecycleEvent(
              (com.google.devtools.build.v1.PublishLifecycleEventRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
      ...
      switch (methodId) {
        case METHODID_PUBLISH_BUILD_TOOL_EVENT_STREAM:
          return (io.grpc.stub.StreamObserver<Req>)
              serviceImpl.publishBuildToolEventStream(
                  (io.grpc.stub.StreamObserver<
                          com.google.devtools.build.v1.PublishBuildToolEventStreamResponse>)
                      responseObserver);
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.devtools.build.v1.PublishLifecycleEventRequest,
                    com.google.protobuf.Empty>(service, METHODID_PUBLISH_LIFECYCLE_EVENT)))
        .addMethod(
            getPublishBuildToolEventStreamMethod(),
  ...
  private abstract static class PublishBuildEventBaseDescriptorSupplier
