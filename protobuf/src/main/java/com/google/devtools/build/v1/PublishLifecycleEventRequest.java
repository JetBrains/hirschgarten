 ...
 */
public final class PublishLifecycleEventRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        PublishLifecycleEventRequest.class.getName());
  }
  ...
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
    ...
    return com.google.devtools.build.v1.BackendProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.devtools.build.v1.PublishLifecycleEventRequest.class,
            com.google.devtools.build.v1.PublishLifecycleEventRequest.Builder.class);
  }
  ...
  public enum ServiceLevel implements com.google.protobuf.ProtocolMessageEnum {
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
      return com.google.devtools.build.v1.PublishLifecycleEventRequest.getDescriptor()
          .getEnumTypes()
          .get(0);
    }
   ...
   * </pre>
   *
   * <code>.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel service_level = 1;
   * </code>
   *
  ...
  public com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel getServiceLevel() {
    com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel result =
        com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel.forNumber(
            serviceLevel_);
    return result == null
        ? com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel.UNRECOGNIZED
        : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (serviceLevel_
        != com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel.NONINTERACTIVE
            .getNumber()) {
  ...
  public int getSerializedSize() {
    ...
    if (serviceLevel_
        != com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel.NONINTERACTIVE
            .getNumber()) {
      size += com.google.protobuf.CodedOutputStream.computeEnumSize(1, serviceLevel_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getBuildEvent());
    }
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getStreamTimeout());
    }
    {
      int dataSize = 0;
      for (int i = 0; i < notificationKeywords_.size(); i++) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.devtools.build.v1.PublishLifecycleEventRequest other =
        (com.google.devtools.build.v1.PublishLifecycleEventRequest) obj;

    if (serviceLevel_ != other.serviceLevel_) return false;
    if (hasBuildEvent() != other.hasBuildEvent()) return false;
    if (hasBuildEvent()) {
      if (!getBuildEvent().equals(other.getBuildEvent())) return false;
    }
    if (hasStreamTimeout() != other.hasStreamTimeout()) return false;
    if (hasStreamTimeout()) {
      if (!getStreamTimeout().equals(other.getStreamTimeout())) return false;
    }
  ...
  public static Builder newBuilder(
      com.google.devtools.build.v1.PublishLifecycleEventRequest prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public com.google.devtools.build.v1.PublishLifecycleEventRequest buildPartial() {
      com.google.devtools.build.v1.PublishLifecycleEventRequest result =
          new com.google.devtools.build.v1.PublishLifecycleEventRequest(this);
      if (bitField0_ != 0) {
    ...
    private void buildPartial0(com.google.devtools.build.v1.PublishLifecycleEventRequest result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.buildEvent_ = buildEventBuilder_ == null ? buildEvent_ : buildEventBuilder_.build();
        to_bitField0_ |= 0x00000001;
      }
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.streamTimeout_ =
            streamTimeoutBuilder_ == null ? streamTimeout_ : streamTimeoutBuilder_.build();
    ...
    public Builder mergeFrom(com.google.devtools.build.v1.PublishLifecycleEventRequest other) {
      if (other == com.google.devtools.build.v1.PublishLifecycleEventRequest.getDefaultInstance())
        return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(getBuildEventFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000002;
                break;
              } // case 18
            case 26:
              {
                input.readMessage(getStreamTimeoutFieldBuilder().getBuilder(), extensionRegistry);
     ...
     */
    @java.lang.Override
    public com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel
        getServiceLevel() {
      com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel result =
          com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel.forNumber(
              serviceLevel_);
    ...
    public Builder setServiceLevel(
        com.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel value) {
      if (value == null) {
      ...
      if (buildEventBuilder_ == null) {
        buildEventBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                ...
                com.google.devtools.build.v1.OrderedBuildEvent.Builder,
                com.google.devtools.build.v1.OrderedBuildEventOrBuilder>(
                getBuildEvent(), getParentForChildren(), isClean());
        buildEvent_ = null;
      }
     ...
     * <code>.google.protobuf.Duration stream_timeout = 3;</code>
     */
    public Builder setStreamTimeout(com.google.protobuf.Duration.Builder builderForValue) {
      if (streamTimeoutBuilder_ == null) {
      ...
      if (streamTimeoutBuilder_ == null) {
        streamTimeoutBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                ...
                com.google.protobuf.Duration.Builder,
                com.google.protobuf.DurationOrBuilder>(
                getStreamTimeout(), getParentForChildren(), isClean());
        streamTimeout_ = null;
      }
  ...
  private static final com.google.protobuf.Parser<PublishLifecycleEventRequest> PARSER =
      new com.google.protobuf.AbstractParser<PublishLifecycleEventRequest>() {
        @java.lang.Override
