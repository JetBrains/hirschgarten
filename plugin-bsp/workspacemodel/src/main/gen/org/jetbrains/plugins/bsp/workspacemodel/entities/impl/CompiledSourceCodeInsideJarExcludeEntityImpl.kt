...
internal class CompiledSourceCodeInsideJarExcludeEntityImpl(private val dataSource: CompiledSourceCodeInsideJarExcludeEntityData) :
  ...
  internal class Builder(result: CompiledSourceCodeInsideJarExcludeEntityData?) :
    ModifiableWorkspaceEntityBase<CompiledSourceCodeInsideJarExcludeEntity, CompiledSourceCodeInsideJarExcludeEntityData>(
      result
    ...
    override fun getEntityClass(): Class<CompiledSourceCodeInsideJarExcludeEntity> =
      CompiledSourceCodeInsideJarExcludeEntity::class.java
  }
}

@OptIn(WorkspaceEntityInternalApi::class)
internal class CompiledSourceCodeInsideJarExcludeEntityData :
  WorkspaceEntityData<CompiledSourceCodeInsideJarExcludeEntity>(), SoftLinkable {
  ...
  override fun getMetadata(): EntityMetadata {
    return MetadataStorageImpl.getMetadataByTypeFqn("org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeEntity") as EntityMetadata
  }
