...
OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "androidTargetType", valueType = ValueTypeMetadata.SimpleType.CustomType(isNullable = false, typeMetadata = FinalClassMetadata.EnumClassMetadata(fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.AndroidTargetType", properties = listOf(), supertypes = listOf("kotlin.Enum",
"kotlin.Comparable",
