...
"com.intellij.platform.workspace.storage.EntitySource"))
        ...
        typeMetadata = FinalClassMetadata.ClassMetadata(fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeId", properties = listOf(OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "presentableName", valueType = primitiveTypeStringNotNullable, withDefault = false),
...
OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "excludedRoots", valueType = ValueTypeMetadata.ParameterizedType(generics = listOf(ValueTypeMetadata.SimpleType.CustomType(isNullable = false, typeMetadata = FinalClassMetadata.KnownClass(fqName = "com.intellij.platform.workspace.storage.url.VirtualFileUrl"))), primitive = primitiveTypeListNotNullable), withDefault = false)), extProperties = arrayListOf(), isAbstract = false)
        ...
        typeMetadata = EntityMetadata(fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeEntity", entityDataFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.impl.CompiledSourceCodeInsideJarExcludeEntityData", supertypes = listOf("com.intellij.platform.workspace.storage.WorkspaceEntity",
...
OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "excludeId", valueType = ValueTypeMetadata.SimpleType.CustomType(isNullable = false, typeMetadata = FinalClassMetadata.ClassMetadata(fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeId", properties = listOf(OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "presentableName", valueType = primitiveTypeStringNotNullable, withDefault = false),
...
OwnPropertyMetadata(isComputable = true, isKey = false, isOpen = false, name = "symbolicId", valueType = ValueTypeMetadata.SimpleType.CustomType(isNullable = false, typeMetadata = FinalClassMetadata.ClassMetadata(fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeId", properties = listOf(OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "presentableName", valueType = primitiveTypeStringNotNullable, withDefault = false),
...
OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "module", valueType = ValueTypeMetadata.EntityReference(connectionType = ConnectionId.ConnectionType.ONE_TO_ONE, entityFqName = "com.intellij.platform.workspace.jps.entities.ModuleEntity", isChild = false, isNullable = false), withDefault = false)), extProperties = listOf(ExtPropertyMetadata(isComputable = false, isOpen = false, name = "jvmBinaryJarsEntity", receiverFqn = "com.intellij.platform.workspace.jps.entities.ModuleEntity", valueType = ValueTypeMetadata.EntityReference(connectionType = ConnectionId.ConnectionType.ONE_TO_ONE, entityFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.JvmBinaryJarsEntity", isChild = true, isNullable = true), withDefault = false)), isAbstract = false)
        ...
        typeMetadata = EntityMetadata(fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.LibraryCompiledSourceCodeInsideJarExcludeEntity", entityDataFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.impl.LibraryCompiledSourceCodeInsideJarExcludeEntityData", supertypes = listOf("com.intellij.platform.workspace.storage.WorkspaceEntity"), properties = listOf(OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "entitySource", valueType = ValueTypeMetadata.SimpleType.CustomType(isNullable = false, typeMetadata = FinalClassMetadata.KnownClass(fqName = "com.intellij.platform.workspace.storage.EntitySource")), withDefault = false),
...
OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "compiledSourceCodeInsideJarExcludeId", valueType = ValueTypeMetadata.SimpleType.CustomType(isNullable = false, typeMetadata = FinalClassMetadata.ClassMetadata(fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeId", properties = listOf(OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "presentableName", valueType = primitiveTypeStringNotNullable, withDefault = false),
OwnPropertyMetadata(isComputable = false, isKey = false, isOpen = false, name = "id", valueType = primitiveTypeIntNotNullable, withDefault = false)), supertypes = listOf("com.intellij.platform.workspace.storage.SymbolicEntityId"))), withDefault = false)), extProperties = arrayListOf(), isAbstract = false)
    ...
    override fun initializeMetadataHash() {
        addMetadataHash(typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.AndroidAddendumEntity", metadataHash = -154682751)
        ...
        addMetadataHash(typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeEntity", metadataHash = -110060933)
        ...
        addMetadataHash(typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.LibraryCompiledSourceCodeInsideJarExcludeEntity", metadataHash = -1259875833)
        addMetadataHash(typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.AndroidTargetType", metadataHash = 1910088846)
        addMetadataHash(typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeId", metadataHash = 2007474707)
