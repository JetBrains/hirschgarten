...
internal object MetadataStorageImpl : MetadataStorageBase() {
  override fun initializeMetadata() {
    ...
    typeMetadata =
      FinalClassMetadata.ObjectMetadata(
        fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.BspEntitySource",
        properties =
          listOf(
            OwnPropertyMetadata(
              isComputable = false,
    ...
    typeMetadata =
      FinalClassMetadata.ObjectMetadata(
        fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.BspDummyEntitySource",
        properties =
          listOf(
            OwnPropertyMetadata(
              isComputable = false,
    ...
    typeMetadata =
      FinalClassMetadata.ClassMetadata(
        fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.PackageNameId",
        properties =
          listOf(
            OwnPropertyMetadata(
              isComputable = false,
    ...
    typeMetadata =
      EntityMetadata(
        fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.AndroidAddendumEntity",
        entityDataFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.impl.AndroidAddendumEntityData",
        ...
        properties =
          listOf(
                ...
                ValueTypeMetadata.SimpleType.CustomType(
                  ...
                  typeMetadata =
                    FinalClassMetadata.EnumClassMetadata(
                      fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.AndroidTargetType",
            ...
            OwnPropertyMetadata(
              ...
              name = "module",
              valueType =
                ValueTypeMetadata.EntityReference(
          ...
          listOf(
            ExtPropertyMetadata(
              ...
              valueType =
                ValueTypeMetadata.EntityReference(
                  connectionType = ConnectionId.ConnectionType.ONE_TO_ONE,
                  entityFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.AndroidAddendumEntity",
                  isChild = true,
                  isNullable = true,
                ),
              withDefault = false,
    ...
    typeMetadata =
      EntityMetadata(
        fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.BspProjectDirectoriesEntity",
        entityDataFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.impl.BspProjectDirectoriesEntityData",
        supertypes = listOf("com.intellij.platform.workspace.storage.WorkspaceEntity"),
        properties =
          listOf(
            OwnPropertyMetadata(
    ...
    typeMetadata =
      EntityMetadata(
        fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.GeneratedJavaSourceRootEntity",
        entityDataFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.impl.GeneratedJavaSourceRootEntityData",
        supertypes = listOf("com.intellij.platform.workspace.storage.WorkspaceEntity"),
        properties =
          listOf(
            OwnPropertyMetadata(
    ...
    typeMetadata =
      EntityMetadata(
        fqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.JvmBinaryJarsEntity",
        entityDataFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.impl.JvmBinaryJarsEntityData",
        supertypes = listOf("com.intellij.platform.workspace.storage.WorkspaceEntity"),
        properties =
          listOf(
            OwnPropertyMetadata(
          ...
          listOf(
            ExtPropertyMetadata(
              ...
              valueType =
                ValueTypeMetadata.EntityReference(
                  connectionType = ConnectionId.ConnectionType.ONE_TO_ONE,
                  entityFqName = "org.jetbrains.plugins.bsp.workspacemodel.entities.JvmBinaryJarsEntity",
                  isChild = true,
                  isNullable = true,
                ),
              withDefault = false,
  ...
  override fun initializeMetadataHash() {
    ...
    addMetadataHash(
      typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.GeneratedJavaSourceRootEntity",
      metadataHash = -1867152896,
    )
    ...
    addMetadataHash(typeFqn = "com.intellij.platform.workspace.storage.EntitySource", metadataHash = -517389248)
    addMetadataHash(typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.BspDummyEntitySource", metadataHash = -9488455)
    addMetadataHash(typeFqn = "org.jetbrains.plugins.bsp.workspacemodel.entities.BspEntitySource", metadataHash = 1740646865)
