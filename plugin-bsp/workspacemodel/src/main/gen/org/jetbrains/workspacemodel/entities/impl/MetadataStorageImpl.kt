...
internal object MetadataStorageImpl : MetadataStorageBase() {
  override fun initializeMetadata() {
    ...
    typeMetadata =
        EntityMetadata(
            ...
            entityDataFqName =
                "org.jetbrains.workspacemodel.entities.impl.AndroidAddendumEntityData",
                            ...
                            ValueTypeMetadata.SimpleType.CustomType(
                                ...
                                typeMetadata =
                                    FinalClassMetadata.EnumClassMetadata(
                                        fqName =
                                            "org.jetbrains.workspacemodel.entities.AndroidTargetType",
                                        ...
                                        values = listOf("APP", "LIBRARY", "TEST"))),
                        withDefault = false),
                    OwnPropertyMetadata(
                        isComputable = false,
                        isKey = false,
                    ...
                    ExtPropertyMetadata(
                        ...
                        valueType =
                            ValueTypeMetadata.EntityReference(
                                connectionType = ConnectionId.ConnectionType.ONE_TO_ONE,
                                entityFqName =
                                    "org.jetbrains.workspacemodel.entities.AndroidAddendumEntity",
                                isChild = true,
                                isNullable = true),
                        withDefault = false)),
            isAbstract = false)
    ...
    typeMetadata =
        EntityMetadata(
            ...
            entityDataFqName =
                "org.jetbrains.workspacemodel.entities.impl.BspProjectDirectoriesEntityData",
            supertypes = listOf("com.intellij.platform.workspace.storage.WorkspaceEntity"),
            properties =
                listOf(
                    OwnPropertyMetadata(
    ...
    typeMetadata =
        EntityMetadata(
            ...
            entityDataFqName = "org.jetbrains.workspacemodel.entities.impl.JvmBinaryJarsEntityData",
            supertypes = listOf("com.intellij.platform.workspace.storage.WorkspaceEntity"),
            properties =
                listOf(
                    OwnPropertyMetadata(
                    ...
                    ExtPropertyMetadata(
                        ...
                        valueType =
                            ValueTypeMetadata.EntityReference(
                                connectionType = ConnectionId.ConnectionType.ONE_TO_ONE,
                                entityFqName =
                                    "org.jetbrains.workspacemodel.entities.JvmBinaryJarsEntity",
                                isChild = true,
                                isNullable = true),
                        withDefault = false)),
            isAbstract = false)
  ...
  override fun initializeMetadataHash() {
    addMetadataHash(
        typeFqn = "org.jetbrains.workspacemodel.entities.AndroidAddendumEntity",
        metadataHash = 433888460)
    addMetadataHash(
        typeFqn = "org.jetbrains.workspacemodel.entities.BspProjectDirectoriesEntity",
        metadataHash = -2029235907)
    addMetadataHash(
        typeFqn = "org.jetbrains.workspacemodel.entities.JvmBinaryJarsEntity",
        metadataHash = 1978770187)
    addMetadataHash(
        typeFqn = "org.jetbrains.workspacemodel.entities.AndroidTargetType",
        metadataHash = -2099175823)
    addMetadataHash(
        typeFqn = "com.intellij.platform.workspace.storage.EntitySource", metadataHash = -27777658)
    addMetadataHash(
        typeFqn = "org.jetbrains.workspacemodel.entities.BspDummyEntitySource",
        metadataHash = 124279478)
    addMetadataHash(
        typeFqn = "org.jetbrains.workspacemodel.entities.BspEntitySource",
        metadataHash = 2092063924)
  }
}
