...
@DisplayName(
    "ProjectDetailsToModuleDetailsTransformer.moduleDetailsForTargetId(projectDetails) tests")
class ProjectDetailsToModuleDetailsTransformerTest {
  ...
  fun `should return empty module details for singular module`() {
    ...
    // when
    val transformer =
        ProjectDetailsToModuleDetailsTransformer(projectDetails, LibraryGraph(emptyList()))
  ...
  fun `should return one module details for project details with one target`() {
    ...
    val targetSources =
        SourcesItem(
            targetId,
            listOf(
                SourceItem("file:///root/dir/example/package/", SourceItemKind.DIRECTORY, false)),
        )
    val targetResources =
        ResourcesItem(
            targetId,
  ...
  fun `should multiple module details for project details with multiple targets`() {
    ...
    val target1Sources =
        SourcesItem(
            target1Id,
            listOf(
                SourceItem("file:///root/dir1/example/package/", SourceItemKind.DIRECTORY, false)),
        )
    ...
    val target2Sources1 =
        SourcesItem(
            ...
            listOf(
                SourceItem(
                    "file:///root/dir2/example/package/File1.java", SourceItemKind.FILE, false),
            ),
        )
    val target2Sources2 =
        SourcesItem(
            ...
            listOf(
                SourceItem(
                    "file:///root/dir2/example/package/File2.java", SourceItemKind.FILE, false),
            ),
        )
