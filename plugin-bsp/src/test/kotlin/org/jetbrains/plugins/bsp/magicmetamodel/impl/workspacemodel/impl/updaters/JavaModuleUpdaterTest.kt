...
internal class JavaModuleUpdaterTest : WorkspaceModelBaseTest() {
  ...
  inner class JavaModuleWithSourcesUpdaterTest {
    ...
    fun `should add one java module with sources to the workspace model`() {
      runTestForUpdaters(listOf(JavaModuleWithSourcesUpdater::class, JavaModuleUpdater::class)) {
          updater ->
        // given
        val module =
            GenericModuleInfo(
        ...
        // when
        val returnedModuleEntity = runTestWriteAction { updater.addEntity(javaModule) }
                    ...
                    ModuleEntity(
                                ...
                                LibraryDependency(
                                    library =
                                        LibraryId(
                                            name = "lib1",
                                            tableId =
                                                LibraryTableId.ModuleLibraryTableId(
                                                    ModuleId("module1")),
                                        ),
                                    exported = true,
                                    scope = DependencyScope.COMPILE,
                      ...
                      javaSettings =
                          JavaModuleSettingsEntity(
                            ...
                            this.compilerOutput =
                                Path("compiler/output").toVirtualFileUrl(virtualFileUrlManager)
                          }
                    },
            )
                    ...
                    ModuleEntity(
                      ...
                      javaSettings =
                          JavaModuleSettingsEntity(
                            ...
                            this.compilerOutput =
                                Path("compiler/output1").toVirtualFileUrl(virtualFileUrlManager)
                          }
                    },
            )
                    ...
                    ModuleEntity(
                      ...
                      javaSettings =
                          JavaModuleSettingsEntity(
                            ...
                            this.compilerOutput =
                                Path("compiler/output2").toVirtualFileUrl(virtualFileUrlManager)
                          }
                    },
            )
  ...
  inner class JavaModuleWithoutSourcesUpdaterTest {
    ...
    fun `should add one java module without sources to the workspace model`() {
      runTestForUpdaters(
          listOf(JavaModuleWithoutSourcesUpdater::class, JavaModuleUpdater::class)) { updater ->
            // given
            val module =
                GenericModuleInfo(
                    name = "module1",
  ...
  private fun runTestForUpdaters(
      updaters:
          List<
              KClass<out WorkspaceModelEntityWithoutParentModuleUpdater<JavaModule, ModuleEntity>>>,
      test: (WorkspaceModelEntityWithoutParentModuleUpdater<JavaModule, ModuleEntity>) -> Unit,
  ) = updaters.map { it.primaryConstructor!! }.forEach { runTest(it, test) }

  private fun runTest(
      updaterConstructor:
          KFunction<WorkspaceModelEntityWithoutParentModuleUpdater<JavaModule, ModuleEntity>>,
      test: (WorkspaceModelEntityWithoutParentModuleUpdater<JavaModule, ModuleEntity>) -> Unit,
  ) {
    beforeEach()
