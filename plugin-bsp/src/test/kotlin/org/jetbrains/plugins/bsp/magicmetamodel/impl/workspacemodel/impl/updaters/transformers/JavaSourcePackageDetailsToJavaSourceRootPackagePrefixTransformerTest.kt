...
@DisplayName(
    "JavaSourcePackageDetailsToJavaSourceRootPackagePrefixTransformer.transform(javaSourcePackageDetails) tests")
class JavaSourcePackageDetailsToJavaSourceRootPackagePrefixTransformerTest {
  ...
  fun `should return no package for equal source dir and single root`() {
    ...
    // when
    val packagePrefix =
        JavaSourcePackageDetailsToJavaSourceRootPackagePrefixTransformer.transform(
