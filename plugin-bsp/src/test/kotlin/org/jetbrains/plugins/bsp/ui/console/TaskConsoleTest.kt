...
private class MockProgressEventListener : BuildProgressListener {
  ...
  private fun addEvent(buildId: Any, event: TestableEvent) {
    event.let { events.merge(buildId, listOf(event)) { acc, x -> acc + x } }
  }
...
class TaskConsoleTest {
        ...
        mapOf(
            "task" to
                listOf(
                    ...
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask 1", "task", "Starting subtask 1"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask 1", "message 1\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "message 1\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask 1", "message 2\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "message 2\n"),
                    TestableBuildEvent(
                        FinishEventImpl::class, "subtask 1", null, "Subtask 1 finished"),
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask 2", "task", "Starting subtask 2"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask 2", "message 3\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "message 3\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask 2", "message 4\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "message 4\n"),
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask 3", "task", "Starting subtask 3"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask 3", "message 5\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "message 5\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask 3", "message 6\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "message 6\n"),
                    TestableBuildEvent(
                        FinishEventImpl::class, "subtask 2", null, "Subtask 2 finished"),
                    TestableBuildEvent(
                        FinishEventImpl::class, "subtask 3", null, "Subtask 3 finished"),
  ...
  fun `should display messages correctly`() {
    ...
    taskConsole.addMessage(
        "subtask", "Message 3") // should send a copy the message to the subtask's parent
        ...
        mapOf(
            "task" to
                listOf(
                    ...
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask", "task", "Subtask started"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 1\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 2\n"),
  ...
  fun `should display diagnostic messages correctly`() {
    ...
    taskConsole.addDiagnosticMessage(
        "origin", "/home/directory/project/src/test/Start.kt", 10, 20, "Diagnostic 7", Kind.WARNING)
        ...
        mapOf(
            "root" to
                listOf(
                    ...
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "child", "root", "Child started"),
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "grandchild", "child", "Grandchild started"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, "child", "Message 1\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 1\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "grandchild", "Message 2\n"),
        ...
        mapOf(
            "root" to
                listOf(
                    TestableBuildEvent(StartBuildEventImpl::class, "root", null, "Root started"),
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask1", "root", "Subtask 1 started"),
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask2", "subtask1", "Subtask 2 started"),
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask3", "subtask2", "Subtask 3 started"),
                    TestableBuildEvent(
                        FinishEventImpl::class, "subtask3", null, "Subtask 3 finished"),
                    TestableBuildEvent(
                        FinishEventImpl::class, "subtask2", null, "Subtask 2 finished"),
                    TestableBuildEvent(
                        FinishEventImpl::class, "subtask1", null, "Subtask 1 finished"),
                    TestableBuildEvent(FinishBuildEventImpl::class, "root", null, "Root finished"),
                ),
        )
  }
            ...
            "root" to
                listOf(
                    ...
                    TestableBuildEvent(
                        ProgressBuildEventImpl::class, "subtask3", "subtask2", "Subtask 3 started"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask3", "Message 1\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask2", "Message 1\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask1", "Message 1\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 1\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask1", "Message 2\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 2\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 3\n"),
                    TestableBuildEvent(
                        FinishEventImpl::class, "subtask3", null, "Subtask 3 finished"),
        ...
        mapOf(
            "root" to
                listOf(
                    ...
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 1\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask3", "Message 2\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask2", "Message 2\n"),
                    TestableBuildEvent(
                        OutputBuildEventImpl::class, null, "subtask1", "Message 2\n"),
                    TestableBuildEvent(OutputBuildEventImpl::class, null, null, "Message 2\n"),
                    TestableBuildEvent(
