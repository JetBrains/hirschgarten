...
class PythonResourceEntityUpdaterTest : WorkspaceModelWithParentPythonModuleBaseTest() {
  ...
  fun `should add one python resource root to the workspace model`() {
    ...
    // when
    val returnedResourceRootEntity =
      runTestWriteAction {
    ...
    val expectedResourceRootEntity =
  ...
  fun `shoulde add multiple python resource roots to the workspace model`() {
    ...
    // when
    val returnedResourceRootEntities =
      runTestWriteAction {
    ...
    val expectedResourceRootEntity3 =
      ExpectedSourceRootEntity(
        contentRootEntity =
          ContentRootEntity(
            entitySource = parentModuleEntity.entitySource,
    ...
    val expectedResourceRootEntities =
      listOf(
