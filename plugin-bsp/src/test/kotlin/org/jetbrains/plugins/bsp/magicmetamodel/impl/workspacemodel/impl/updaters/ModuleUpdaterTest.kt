...
internal class ModuleUpdaterTest : WorkspaceModelBaseTest() {
  ...
  override fun beforeEach() {
    ...
    moduleEntityUpdater =
        ModuleEntityUpdater(workspaceModelEntityUpdaterConfig, defaultDependencies)
  }
  ...
  fun `should add one module to the workspace model`() {
    ...
    // when
    val returnedModuleEntity = runTestWriteAction { moduleEntityUpdater.addEntity(module) }
  ...
  fun `should add multiple modules to the workspace model`() {
    ...
    // when
    val returnedModuleEntries = runTestWriteAction { moduleEntityUpdater.addEntries(modules) }
