...
class SourceItemToSourceRootTransformerTest {
  ...
  fun `should return single file for single source file`() {
    testGeneratedAndNotGeneratedSources { generated ->
      // given
      val sourceItem =
          SourceItem("file:///example/source/File.java", SourceItemKind.FILE, generated)
    ...
    testGeneratedAndNotGeneratedSources { generated ->
      ...
      val sourceItems =
          listOf(
              ...
              SourceItem(
                  "file:///example/source1/subpackage/File2.java", SourceItemKind.FILE, generated),
      ...
      val expectedSource1SubpackagePath =
          URI.create("file:///example/source1/subpackage/File2.java").toPath()
    ...
    testGeneratedAndNotGeneratedSources { generated ->
      ...
      val sourceItems =
          listOf(
              ...
              SourceItem(
                  "file:///example/source1/subpackage/", SourceItemKind.DIRECTORY, generated),
      ...
      sourcesDirs shouldContainExactlyInAnyOrder
          listOf(expectedSource1, expectedSource1Subpackage, expectedSource2)
    }
  }
    ...
    testGeneratedAndNotGeneratedSources { generated ->
      ...
      val sourceItems =
          listOf(
              SourceItem("file:///example/source1/", SourceItemKind.DIRECTORY, generated),
              SourceItem(
                  "file:///example/source1/subpackage/File1.java", SourceItemKind.FILE, generated),
              SourceItem("file:///example/source2/", SourceItemKind.DIRECTORY, generated),
              SourceItem("file:///example/source2/File1.java", SourceItemKind.FILE, generated),
          )
      ...
      val expectedSource1SubpackagePath =
          URI.create("file:///example/source1/subpackage/File1.java").toPath()
      val expectedSource1Subpackage = SourceRoot(expectedSource1SubpackagePath, generated, true)
