...
internal class PythonModuleUpdaterTest : WorkspaceModelBaseTest() {
  ...
  inner class PythonModuleWithSourcesUpdaterTest {
    ...
    fun `should add one python module with sources to the workspace model`() {
      runTestForUpdaters(
          ...
          listOf(PythonModuleWithSourcesUpdater::class, PythonModuleUpdater::class)) { updater ->
            // given
            val module =
                GenericModuleInfo(
                    name = "module1",
            ...
            // when
            val returnedModuleEntity = runTestWriteAction { updater.addEntity(pythonModule) }
            ...
            loadedEntries(ModuleEntity::class.java) shouldContainExactlyInAnyOrder
            ...
            val expectedResourceRootEntity1 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
                            entitySource = expectedModuleEntity.moduleEntity.entitySource,
            ...
            val expectedResourceRootEntity2 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
                            entitySource = expectedModuleEntity.moduleEntity.entitySource,
    ...
    fun `should add multiple python modules with sources to the workspace model`() {
      runTestForUpdaters(
          ...
          listOf(PythonModuleWithSourcesUpdater::class, PythonModuleUpdater::class)) { updater ->
            ...
            val sourcePath21 =
                URI.create("file:///another/root/dir/another/example/package/").toPath()
            val sourceRoots2 =
                listOf(
                    GenericSourceRoot(
            ...
            val resourcePath21 =
                URI.create("file:///another/root/dir/another/example/resource/File1.txt").toPath()
            val resourceRoots2 =
                listOf(
                    ResourceRoot(
            ...
            // when
            val returnedModuleEntries = runTestWriteAction { updater.addEntries(pythonModules) }
            ...
            val expectedPythonSourceRootEntity11 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
            ...
            val expectedPythonSourceRootEntity12 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
                            entitySource = expectedModuleEntity1.moduleEntity.entitySource,
            ...
            val expectedPythonSourceRootEntity21 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
            ...
            val expectedResourceRootEntity11 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
                            entitySource = expectedModuleEntity1.moduleEntity.entitySource,
            ...
            val expectedResourceRootEntity12 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
                            entitySource = expectedModuleEntity1.moduleEntity.entitySource,
            ...
            val expectedResourceRootEntity21 =
                ExpectedSourceRootEntity(
                    contentRootEntity =
                        ContentRootEntity(
                            entitySource = expectedModuleEntity2.moduleEntity.entitySource,
  ...
  inner class PythonModuleWithoutSourcesUpdaterTest {
    ...
    fun `should add one python module without sources to the workspace model`() {
      runTestForUpdaters(
          isPythonSupportEnabled = true,
          listOf(PythonModuleWithoutSourcesUpdater::class, PythonModuleUpdater::class)) { updater ->
            // given
            val module =
                GenericModuleInfo(
                    name = "module1",
    ...
    fun `should add multiple python modules without sources to the workspace model`() {
      runTestForUpdaters(
          ...
          listOf(PythonModuleWithoutSourcesUpdater::class, PythonModuleUpdater::class)) { updater ->
            ...
            // when
            val returnedModuleEntries = runTestWriteAction { updater.addEntries(javaModules) }
  ...
  private fun runTestForUpdaters(
      ...
      updaters:
          List<
              KClass<
                  out WorkspaceModelEntityWithoutParentModuleUpdater<PythonModule, ModuleEntity>>>,
      test: (WorkspaceModelEntityWithoutParentModuleUpdater<PythonModule, ModuleEntity>) -> Unit,
  ) = updaters.map { it.primaryConstructor!! }.forEach { runTest(it, test, isPythonSupportEnabled) }

  private fun runTest(
      updaterConstructor:
          KFunction<WorkspaceModelEntityWithoutParentModuleUpdater<PythonModule, ModuleEntity>>,
      test: (WorkspaceModelEntityWithoutParentModuleUpdater<PythonModule, ModuleEntity>) -> Unit,
