...
class BspProjectModuleBuildTasksTracker : PersistentStateComponent<BspProjectModuleBuildTasksTracker> {
  ...
  companion object {
     ...
     */
    private fun ProjectTaskManager.Result.isRunByBsp() = anyTaskMatches { task, _ -> BspProjectTaskRunner().canRun(task) }
    ...
    @JvmStatic
    fun getInstance(project: Project): BspProjectModuleBuildTasksTracker = project.getService(BspProjectModuleBuildTasksTracker::class.java)
  }
