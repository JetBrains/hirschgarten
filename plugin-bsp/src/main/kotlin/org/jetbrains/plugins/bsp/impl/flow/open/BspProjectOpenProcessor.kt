...
public interface BspProjectOpenProcessorExtension : WithBuildToolId {
   ...
   *
   * In case you want to support a particular build tool in a more "native" way a dedicated [org.jetbrains.plugins.bsp.impl.flow.open.BaseBspProjectOpenProcessor]
