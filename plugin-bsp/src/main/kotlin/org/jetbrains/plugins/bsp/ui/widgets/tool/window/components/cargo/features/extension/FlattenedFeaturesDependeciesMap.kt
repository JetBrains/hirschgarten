...
public class FlattenedFeaturesDependenciesMap(
  private val map: Map<String, Set<String>>,
) : Map<String, Set<String>> by map {
  public fun toState(): FlattenedFeaturesDependenciesMapState =
    FlattenedFeaturesDependenciesMapState(map)

  public companion object {
    public fun enablingForGivenPackage(packageFeatures: PackageFeatures): FlattenedFeaturesDependenciesMap {
      val enablementMap: MutableMap<String, Set<String>> = mutableMapOf()
      val availableFeatures = packageFeatures.availableFeatures
    ...
    public fun disablingFromGivenEnabling(
      flattenedEnablingMap: Map<String, Set<String>>,
    ): FlattenedFeaturesDependenciesMap {
...
public data class FlattenedFeaturesDependenciesMapState(
  ...
  override fun fromState(): FlattenedFeaturesDependenciesMap =
    FlattenedFeaturesDependenciesMap(map)
}
