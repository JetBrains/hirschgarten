...
public class ConnectAction :
    SuspendableAction({ BspPluginBundle.message("connect.action.text") }), DumbAware {
  override suspend fun actionPerformed(project: Project, e: AnActionEvent) {
    ...
    try {
      project.connection.connect("bsp-connect") {
      ...
      bspSyncConsole.finishTask(
          "bsp-connect", BspPluginBundle.message("console.task.connect.success"))
    } catch (e: Exception) {
      bspSyncConsole.finishTask(
          "bsp-connect",
          BspPluginBundle.message("console.task.connect.failed"),
          FailureResultImpl(e))
    }
  }
