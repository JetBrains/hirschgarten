...
public interface BspConnection {
   ...
   * making sure that the newest available server is used (by calling [org.jetbrains.plugins.bsp.impl.server.connection.ConnectionDetailsProviderExtension.provideNewConnectionDetails])
   */
