 ...
 */
class BspModuleFileIndex(private val module: Module) : ModuleFileIndexImpl(module) {
  override fun iterateContent(processor: ContentIterator, filter: VirtualFileFilter?): Boolean {
    if (!module.project.isBspProject) return super.iterateContent(processor, filter)
