package org.jetbrains.plugins.bsp.console
 ...
 */
class BspConsoleFilter(private val project: Project) : Filter {
...
class BspConsoleFilterProvider : ConsoleFilterProvider {
  override fun getDefaultFilters(project: Project): Array<out Filter> =
    if (project.isBspProject) arrayOf(BspConsoleFilter(project)) else emptyArray()
}
