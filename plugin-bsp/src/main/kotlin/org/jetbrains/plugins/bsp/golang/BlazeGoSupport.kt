 ...
 *
 *
 * If this is enabled, we override some default Go plugin behaviors.
 */
object BlazeGoSupport {
  val blazeGoSupportEnabled: BoolExperiment = BoolExperiment("blaze.go.support.enabled", true)
}
