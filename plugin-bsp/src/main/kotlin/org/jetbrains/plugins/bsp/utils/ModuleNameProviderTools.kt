...
private fun createNameReformatProvider(buildToolId: BuildToolId): (BuildTargetInfo) -> String {
  ...
  return { buildTargetInfo ->
    val sanitizedName =
        bspBuildTargetClassifier.calculateBuildTargetName(buildTargetInfo).replaceDots()
...
public fun TargetNameReformatProvider?.orDefault(): TargetNameReformatProvider =
    this ?: DefaultModuleNameProvider
