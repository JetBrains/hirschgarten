...
internal class OpenBspToolWindowCommand(text: String, line: Int) :
  ...
  override suspend fun doExecute(context: PlaybackContext) {
    ...
    val toolWindow =
        ToolWindowManager.getInstance(project).getToolWindow(project.bspToolWindowId) ?: return
    withContext(Dispatchers.EDT) { toolWindow.show() }
  }
}
