package org.jetbrains.plugins.bsp.impl.flow.open.wizard
...
internal open class ChooseConnectionFileStep(projectPath: VirtualFile) : ImportProjectWizardStep() {
  ...
  override val panel: DialogPanel =
    panel {
      row {
        panel {
          row {
