...
public class BspJvmEnvironmentProgramPatcher : JavaProgramPatcher() {
  ...
  private fun JavaParameters.applyJavaParametersFromItem(
      item: JvmEnvironmentItem,
      includeJpsClassPaths: Boolean
  ) {
    ...
    val newClassPath = if (includeJpsClassPaths) jpsClassPaths + item.classpath else item.classpath
