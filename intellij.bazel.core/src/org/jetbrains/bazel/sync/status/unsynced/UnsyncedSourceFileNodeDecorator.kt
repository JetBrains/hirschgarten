...
private val RELATED_UNSYNCED_SOURCE_TYPES = setOf(LanguageClass.GO)
...
internal fun VirtualFile.isUnsyncedSourceFile(project: Project): Boolean {
  ...
  if (LanguageClass.fromExtension(extension) !in RELATED_UNSYNCED_SOURCE_TYPES) return false
