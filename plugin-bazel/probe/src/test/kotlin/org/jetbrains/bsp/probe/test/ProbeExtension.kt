...
fun emptyBackgroundTaskWithoutTimeouts(
    ...
    WaitLogic.emptyBackgroundTasks(basicCheck, ensurePeriod, ensureFrequency, atMost)
        .doWhileWaiting { _ ->
          action()
          BoxedUnit.UNIT
        }
...
fun SearchableComponent.fixture(): CommonContainerFixture =
    searchContext() as? CommonContainerFixture
        ?: throw InvalidClassException(
            "Element ${searchContext()} is not a CommonContainerFixture ")
...
fun SearchableComponent.setText(text: String): Unit =
    fixture().runJs("component.setText('$text');", true)
...
fun IntelliJFixture.withBuild(build: String, version: String? = null) =
    withVersion(`IdeProbeTestRunner$`.`MODULE$`.version(build, Option.apply(version)))
...
object Query {
  ...
  fun dialog(vararg attributes: Pair<String, String>): String =
      div("class" to "MyDialog", *attributes)

  fun button(vararg attributes: Pair<String, String>): String =
      div("class" to "JButton", *attributes)
  ...
  fun radioButton(vararg attributes: Pair<String, String>): String =
      div("class" to "JRadioButton", *attributes)
  ...
  fun className(name: String, vararg attributes: Pair<String, String>): String =
      div("class" to name, *attributes)
