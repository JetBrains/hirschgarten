...
class JavaLanguagePluginJdepsTest {
  ...
  @Test
  fun `collectJdepsLibraries filters excluded and header_ jars and dedupes against outputs`() {
  ...
  @Test
  fun `collectJdepsLibraries removes jars provided transitively by dependencies`() {
