...
import org.jetbrains.bazel.workspacemodel.entities.BazelJavaSourceRootEntityBuilder
import org.jetbrains.bazel.workspacemodel.entities.PackageNameId

@GeneratedCodeApiVersion(3)
@GeneratedCodeImplVersion(7)
@OptIn(WorkspaceEntityInternalApi::class)
internal class BazelJavaSourceRootEntityImpl(private val dataSource: BazelJavaSourceRootEntityData): BazelJavaSourceRootEntity, WorkspaceEntityBase(dataSource) {
...
internal class Builder(result: BazelJavaSourceRootEntityData?): ModifiableWorkspaceEntityBase<BazelJavaSourceRootEntity, BazelJavaSourceRootEntityData>(result), BazelJavaSourceRootEntityBuilder {
...
override fun wrapAsModifiable(diff: MutableEntityStorage): WorkspaceEntityBuilder<BazelJavaSourceRootEntity>{
