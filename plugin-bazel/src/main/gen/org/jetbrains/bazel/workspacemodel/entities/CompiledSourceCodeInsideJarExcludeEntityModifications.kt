...
): CompiledSourceCodeInsideJarExcludeEntity = modifyEntity(CompiledSourceCodeInsideJarExcludeEntityBuilder::class.java, entity, modification)
...
entitySource: EntitySource,
init: (CompiledSourceCodeInsideJarExcludeEntityBuilder.() -> Unit)? = null,
): CompiledSourceCodeInsideJarExcludeEntityBuilder = CompiledSourceCodeInsideJarExcludeEntityType(relativePathsInsideJarToExclude, librariesFromInternalTargetsUrls, excludeId, entitySource, init)
