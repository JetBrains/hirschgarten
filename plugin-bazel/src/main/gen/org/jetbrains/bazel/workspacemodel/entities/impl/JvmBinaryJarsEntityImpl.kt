...
internal class JvmBinaryJarsEntityImpl(private val dataSource: JvmBinaryJarsEntityData): JvmBinaryJarsEntity, WorkspaceEntityBase(dataSource) {

private companion object {
internal val MODULE_CONNECTION_ID: ConnectionId = ConnectionId.create(ModuleEntity::class.java, JvmBinaryJarsEntity::class.java, ConnectionId.ConnectionType.ONE_TO_ONE, false)
...
internal class Builder(result: JvmBinaryJarsEntityData?): ModifiableWorkspaceEntityBase<JvmBinaryJarsEntity, JvmBinaryJarsEntityData>(result), JvmBinaryJarsEntityBuilder {
