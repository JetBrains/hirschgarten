...
import org.jetbrains.bazel.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeEntityBuilder
import org.jetbrains.bazel.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeId

@GeneratedCodeApiVersion(3)
@GeneratedCodeImplVersion(7)
@OptIn(WorkspaceEntityInternalApi::class)
internal class CompiledSourceCodeInsideJarExcludeEntityImpl(private val dataSource: CompiledSourceCodeInsideJarExcludeEntityData): CompiledSourceCodeInsideJarExcludeEntity, WorkspaceEntityBase(dataSource) {
...
internal class Builder(result: CompiledSourceCodeInsideJarExcludeEntityData?): ModifiableWorkspaceEntityBase<CompiledSourceCodeInsideJarExcludeEntity, CompiledSourceCodeInsideJarExcludeEntityData>(result), CompiledSourceCodeInsideJarExcludeEntityBuilder {
...
if (this.librariesFromInternalTargetsUrls != dataSource.librariesFromInternalTargetsUrls) this.librariesFromInternalTargetsUrls = dataSource.librariesFromInternalTargetsUrls.toMutableSet()
...
override fun wrapAsModifiable(diff: MutableEntityStorage): WorkspaceEntityBuilder<CompiledSourceCodeInsideJarExcludeEntity>{
...
return MetadataStorageImpl.getMetadataByTypeFqn("org.jetbrains.bazel.workspacemodel.entities.CompiledSourceCodeInsideJarExcludeEntity") as EntityMetadata
}
...
return CompiledSourceCodeInsideJarExcludeEntity(relativePathsInsideJarToExclude, librariesFromInternalTargetsUrls, excludeId, entitySource)
}
