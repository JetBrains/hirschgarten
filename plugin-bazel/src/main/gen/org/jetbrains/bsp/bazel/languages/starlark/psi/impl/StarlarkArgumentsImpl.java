...
public class StarlarkArgumentsImpl extends ASTWrapperPsiElement implements StarlarkArguments {

  public StarlarkArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarlarkArgument> getArgumentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarlarkArgument.class);
  }
