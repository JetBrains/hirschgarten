...
public class StarlarkSimpleStmtImpl extends ASTWrapperPsiElement implements StarlarkSimpleStmt {

  public StarlarkSimpleStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarlarkSmallStmt> getSmallStmtList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarlarkSmallStmt.class);
  }
