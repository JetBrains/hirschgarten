...
public class StarlarkCallSuffixImpl extends ASTWrapperPsiElement implements StarlarkCallSuffix {

  public StarlarkCallSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarlarkArguments getArguments() {
    return findChildByClass(StarlarkArguments.class);
  }
