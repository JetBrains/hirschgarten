...
public class StarlarkBinaryOperatorImpl extends ASTWrapperPsiElement implements StarlarkBinaryOperator {

  public StarlarkBinaryOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
