...
public class StarlarkUnaryOperatorImpl extends ASTWrapperPsiElement implements StarlarkUnaryOperator {

  public StarlarkUnaryOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
