...
public class StarlarkBinaryExpr21Impl extends ASTWrapperPsiElement implements StarlarkBinaryExpr21 {

  public StarlarkBinaryExpr21Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarlarkVisitor visitor) {
    visitor.visitBinaryExpr21(this);
  }
