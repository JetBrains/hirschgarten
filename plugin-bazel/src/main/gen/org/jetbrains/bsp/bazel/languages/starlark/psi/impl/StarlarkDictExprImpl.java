...
public class StarlarkDictExprImpl extends ASTWrapperPsiElement implements StarlarkDictExpr {

  public StarlarkDictExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarlarkEntries getEntries() {
    return findChildByClass(StarlarkEntries.class);
  }
