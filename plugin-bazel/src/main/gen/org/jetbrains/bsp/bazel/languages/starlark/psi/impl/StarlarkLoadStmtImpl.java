...
public class StarlarkLoadStmtImpl extends ASTWrapperPsiElement implements StarlarkLoadStmt {

  public StarlarkLoadStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarlarkVisitor visitor) {
    visitor.visitLoadStmt(this);
  }
