...
public class StarlarkIfLastExprImpl extends ASTWrapperPsiElement implements StarlarkIfLastExpr {

  public StarlarkIfLastExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarlarkVisitor visitor) {
    visitor.visitIfLastExpr(this);
  }
