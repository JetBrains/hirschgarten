...
public class StarlarkUnaryExpressionImpl extends StarlarkExpressionImpl implements StarlarkUnaryExpression {

  public StarlarkUnaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarlarkUnaryOperator getUnaryOperator() {
    return findNotNullChildByClass(StarlarkUnaryOperator.class);
  }
