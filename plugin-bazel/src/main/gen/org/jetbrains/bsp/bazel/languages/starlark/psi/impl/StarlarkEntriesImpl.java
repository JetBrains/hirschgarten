...
public class StarlarkEntriesImpl extends ASTWrapperPsiElement implements StarlarkEntries {

  public StarlarkEntriesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarlarkVisitor visitor) {
    visitor.visitEntries(this);
  }
  ...
  @Override
  @NotNull
  public List<StarlarkEntry> getEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarlarkEntry.class);
  }
