...
public class StarlarkParametersImpl extends ASTWrapperPsiElement implements StarlarkParameters {

  public StarlarkParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarlarkParameter> getParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarlarkParameter.class);
  }
