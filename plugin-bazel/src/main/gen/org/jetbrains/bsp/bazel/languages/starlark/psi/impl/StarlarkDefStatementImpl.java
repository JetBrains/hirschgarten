...
public class StarlarkDefStatementImpl extends StarlarkStatementImpl implements StarlarkDefStatement {

  public StarlarkDefStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
