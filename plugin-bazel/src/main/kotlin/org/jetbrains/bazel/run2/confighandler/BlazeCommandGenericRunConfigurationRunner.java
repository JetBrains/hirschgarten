...
import org.jetbrains.bazel.run2.processhandler.LineProcessingProcessAdapter;
import org.jetbrains.bazel.run2.processhandler.ScopedBlazeProcessHandler;
import org.jetbrains.bazel.run2.smrunner.BlazeTestEventsHandler;
import org.jetbrains.bazel.run2.smrunner.BlazeTestUiSession;
...
import org.jetbrains.bazel.run2.testlogs.LocalBuildEventProtocolTestFinderStrategy;
...
public final class BlazeCommandGenericRunConfigurationRunner
  ...
  public static class BlazeCommandRunProfileState extends CommandLineState {
    ...
    public BlazeCommandRunProfileState(ExecutionEnvironment environment) {
      ...
      this.handlerState =
          (BlazeCommandRunConfigurationCommonState) configuration.getHandler().state;
        ...
        final var testUiSession =
            BlazeTestUiSession.create(
                ImmutableList.<String>builder()
                    ...
                    .addAll(buildResultHelper.getBBlazeCommandGenericRunConfigurationHandlerProvider?>uildFlags())
                    .build(),
  ...
  private record WritingOutputSink(ConsoleView console) implements OutputSink<PrintOutput> {
