 ...
 */
package org.jetbrains.bazel.run2.exporter;
    ...
    runWithPathVariableSet(
        ...
        () -> {
          ...
          if (config instanceof BlazeRunConfiguration) {
            ((BlazeRunConfiguration) config).keepInSync = true;
          }
