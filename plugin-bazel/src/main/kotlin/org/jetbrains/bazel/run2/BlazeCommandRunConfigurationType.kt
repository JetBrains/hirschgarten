...
class BlazeCommandRunConfigurationType : ConfigurationType, DumbAware {
  ...
  class BlazeCommandRunConfigurationFactory(type: ConfigurationType) : ConfigurationFactory(type),
    DumbAware {
  ...
  override fun getConfigurationTypeDescription(): String? {
    return String.format(
      "Configuration for launching arbitrary %s commands.", "Bazel"
    )
  }
  ...
  override fun getId(): String {
    return "BazelCommandRunConfigurationType"
  }
