...
import org.jetbrains.bazel.flow.open.wizard.ImportProjectWizard
import org.jetbrains.bsp.protocol.utils.parseBspConnectionDetails

class DefaultConnectionDetailsProviderExtension : ConnectionDetailsProviderExtension {
...
data class BspConnectionDetailsState(
...
data class DefaultConnectionDetailsProviderState(
...
class DefaultConnectionDetailsProviderExtensionService :
...
val Project.stateService: DefaultConnectionDetailsProviderExtensionService
