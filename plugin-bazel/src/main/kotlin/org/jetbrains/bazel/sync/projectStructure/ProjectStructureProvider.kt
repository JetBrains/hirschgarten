 ...
 */
internal interface ProjectStructureDiff {
  /**
 ...
 */
@ApiStatus.Internal
class AllProjectStructuresDiff internal constructor(private val project: Project, diffs: List<ProjectStructureDiff>) {
  private val diffs = diffs.associateBy { it::class.java }

  @Suppress("UNCHECKED_CAST")
  internal fun <TDiff : ProjectStructureDiff> diffOfType(diffClazz: Class<TDiff>): TDiff =
 ...
 */
internal interface ProjectStructureProvider<TDiff : ProjectStructureDiff> {
  /**
