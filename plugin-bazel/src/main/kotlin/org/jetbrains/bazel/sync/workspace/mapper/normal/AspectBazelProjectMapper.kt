...
class AspectBazelProjectMapper(
  ...
  suspend fun createProject(
    ...
    val (targetsToImportSeq, targetsAsLibraries) = measure("Select targets") { // the import depth mechanism does not apply for certain languages (e.g., Go)
      ...
      val normalAtDepth = dependencyGraph.allTargetsAtDepth(
    ...
    val targetsToImport = targetsToImportSeq.toList()
