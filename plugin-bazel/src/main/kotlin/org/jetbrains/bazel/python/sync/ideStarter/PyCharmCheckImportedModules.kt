...
internal class PyCharmCheckImportedModules(text: String, line: Int) : PlaybackCommandCoroutineAdapter(text, line) {
...
internal class PyCharmCheckImportedModulesProvider : CommandProvider {
