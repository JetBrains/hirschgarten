...
object BazelFeatureFlags {
  ...
  const val JDK_RESOLVER_TOOLCHAIN_FIRST = "bazel.jdk.resolver.toolchain.first"
  ...
  val isJdkResolverToolchainFirst: Boolean
    get() = isEnabled(JDK_RESOLVER_TOOLCHAIN_FIRST)
