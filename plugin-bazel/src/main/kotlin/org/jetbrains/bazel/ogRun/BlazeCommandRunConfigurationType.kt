...
class BlazeCommandRunConfigurationType :
  ...
  override fun getConfigurationTypeDescription(): String = "Configuration for launching arbitrary Bazel commands."

  override fun getIcon(): Icon = BazelPluginIcons.bazel

  override fun getId(): String = "BlazeCommandRunConfigurationType"
