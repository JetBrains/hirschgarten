 ...
 */
class BlazeCommandGenericRunConfigurationRunner

    : BlazeCommandRunConfigurationRunner {
    override fun getRunProfileState(executor: Executor?, environment: ExecutionEnvironment): RunProfileState {
        return BlazeCommandRunProfileState(environment)
    }
    ...
    class BlazeCommandRunProfileState(environment: ExecutionEnvironment) : CommandLineState(environment) {
        ...
        override fun startProcess(): ProcessHandler {
            ...
            val importSettings: BlazeImportSettings = checkNotNull(
