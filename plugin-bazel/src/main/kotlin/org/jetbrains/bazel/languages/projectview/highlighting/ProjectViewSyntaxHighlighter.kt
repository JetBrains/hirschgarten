...
object ProjectViewSyntaxHighlighter : SyntaxHighlighterBase() {
  private val keys =
      mapOf(
          ...
          ProjectViewTokenTypes.DERIVE_TARGETS_FROM_DIRECTORIES_KEYWORD to
              ProjectViewHighlightingColors.KEYWORD,
          ...
          ProjectViewTokenTypes.ADDITIONAL_LANGUAGES_KEYWORD to
              ProjectViewHighlightingColors.KEYWORD,
          ProjectViewTokenTypes.JAVA_LANGUAGE_LEVEL_KEYWORD to
              ProjectViewHighlightingColors.KEYWORD,
          ...
          ProjectViewTokenTypes.IMPORT_RUN_CONFIGURATION_KEYWORD to
              ProjectViewHighlightingColors.KEYWORD,
          ProjectViewTokenTypes.ANDROID_SDK_PLATFORM_KEYWORD to
              ProjectViewHighlightingColors.KEYWORD,
          ProjectViewTokenTypes.ANDROID_MIN_SDK_KEYWORD to ProjectViewHighlightingColors.KEYWORD,
          ProjectViewTokenTypes.GENERATED_ANDROID_RESOURCE_DIRECTORIES_KEYWORD to
              ProjectViewHighlightingColors.KEYWORD,
          ProjectViewTokenTypes.TS_CONFIG_RULES_KEYWORD to ProjectViewHighlightingColors.KEYWORD,
          ProjectViewTokenTypes.BUILD_MANUAL_TARGETS_KEYWORD to
              ProjectViewHighlightingColors.KEYWORD,
...
class ProjectViewSyntaxHighlighterFactory : SyntaxHighlighterFactory() {
  ...
  ): SyntaxHighlighter = ProjectViewSyntaxHighlighter
}
