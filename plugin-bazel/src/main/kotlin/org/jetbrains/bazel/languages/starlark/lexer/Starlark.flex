...
TRIPLE_APOSTROPHE_STRING = {TRIPLE_APOSTROPHE}{TRIPLE_APOSTROPHE_STRING_ITEM}*{TRIPLE_APOSTROPHE}?
TRIPLE_APOSTROPHE_STRING_ITEM = [^\\'] | {ONE_TWO_APOSTROPHES} | {ESCAPE_SEQUENCE}
TRIPLE_APOSTROPHE = (\'\'\')
ONE_TWO_APOSTROPHES = ('[^\\']) | ('\\[^]) | (''[^\\']) | (''\\[^])

TRIPLE_QUOTE_STRING = {TRIPLE_QUOTE}{TRIPLE_QUOTE_STRING_ITEM}*{TRIPLE_QUOTE}?
