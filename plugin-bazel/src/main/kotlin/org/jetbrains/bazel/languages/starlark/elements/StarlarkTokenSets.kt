...
object StarlarkTokenSets {
  ...
  val OPEN_BRACKETS =
      TokenSet.create(
          StarlarkTokenTypes.LBRACKET, StarlarkTokenTypes.LBRACE, StarlarkTokenTypes.LPAR)

  val CLOSE_BRACKETS =
      TokenSet.create(
          StarlarkTokenTypes.RBRACKET, StarlarkTokenTypes.RBRACE, StarlarkTokenTypes.RPAR)
  ...
  val ENDS_OF_STATEMENT =
      TokenSet.create(StarlarkTokenTypes.STATEMENT_BREAK, StarlarkTokenTypes.SEMICOLON)
