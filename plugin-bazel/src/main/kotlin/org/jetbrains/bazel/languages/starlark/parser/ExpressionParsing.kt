  ...
  private fun parsePrimaryExpression(isTarget: Boolean): Boolean =
    if (builder.tokenType in StarlarkTokenSets.PRIMARY_EXPRESSION_STARTERS) {
      when (builder.tokenType) {
        ...
        StarlarkTokenTypes.NONE_KEYWORD -> buildTokenElement(StarlarkElementTypes.NONE_LITERAL_EXPRESSION, builder)
        StarlarkTokenTypes.TRUE_KEYWORD -> buildTokenElement(StarlarkElementTypes.TRUE_LITERAL_EXPRESSION, builder)
        StarlarkTokenTypes.FALSE_KEYWORD -> buildTokenElement(StarlarkElementTypes.FALSE_LITERAL_EXPRESSION, builder)
