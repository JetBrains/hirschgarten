...
object SearchUtils {
  ...
  private fun searchInParent(
    ...
    when (parent) {
      ...
      is StarlarkListCompExpression -> parent.searchInListComprehension(processor)
      else -> true
    }
  ...
  private fun StarlarkListCompExpression.searchInListComprehension(processor: Processor<StarlarkElement>): Boolean =
