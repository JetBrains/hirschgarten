...
object BazelGlobalFunctions {
  ...
  val MODULE_FUNCTIONS =
    mapOf(
      "archive_override" to BazelGlobalFunction("archive_override"),
      "bazel_dep" to BazelGlobalFunction("bazel_dep", listOf(
        BazelGlobalFunctionParameter("name", "\"\"", true),
      )),
      "git_override" to BazelGlobalFunction("git_override"),
      "include" to BazelGlobalFunction("include"),
      "local_path_override" to BazelGlobalFunction("local_path_override"),
      "module" to BazelGlobalFunction("module"),
      "multiple_version_override" to BazelGlobalFunction("multiple_version_override"),
      ...
      "single_version_override" to BazelGlobalFunction("single_version_override"),
      "use_extension" to BazelGlobalFunction("use_extension"),
      "use_repo" to BazelGlobalFunction("use_repo"),
      "use_repo_rule" to BazelGlobalFunction("use_repo_rule"),
    )
