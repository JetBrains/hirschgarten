...
// Currently this class is empty, but needs to be kept nevertheless to satisfy XLineBreakpointType's type parameter
class StarlarkBreakpointProperties : XBreakpointProperties<StarlarkBreakpointProperties>() {
  ...
  override fun loadState(state: StarlarkBreakpointProperties) { }
}
