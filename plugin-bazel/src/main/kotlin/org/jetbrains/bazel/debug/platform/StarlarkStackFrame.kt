...
class StarlarkStackFrame(
  ...
  override fun getEvaluator(): XDebuggerEvaluator = if (isTopFrame) evaluator else notTopFrameError

  private companion object {
    val notTopFrameError =
      StarlarkDebuggerEvaluator.ErrorEvaluator(BazelPluginBundle.message("starlark.debug.not.top.frame"))
  }
}
