...
internal sealed class SimplifiedFileEvent private constructor(
  ...
  /** Event for externally submitted files (e.g., generated by Bazel build) that need module assignment. */
  class ExternalCreate(file: VirtualFile)
    : SimplifiedFileEvent(fileAdded = file.path, newVirtualFile = file)
