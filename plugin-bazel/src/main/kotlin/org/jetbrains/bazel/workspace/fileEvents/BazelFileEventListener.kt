...
class BazelFileEventListener : BulkFileListenerBackgroundable {
  ...
  private suspend fun applyAllChanges(allFileEvents: List<SimplifiedFileEvent>, context: ProcessingContext) {
    ...
    updatePackageMarkerEntities(allFileEvents, context)
  ...
  private suspend fun updatePackageMarkerEntities(
    ...
    allFileEvents.filterIsInstance<CreateDirectory>().mapNotNull { createDirectoryEvent ->
  ...
  private suspend fun updatePackageMarkerEntity(
    ...
    if (findModuleSourceRoot(workspaceModelIndex, dir) != null) {
