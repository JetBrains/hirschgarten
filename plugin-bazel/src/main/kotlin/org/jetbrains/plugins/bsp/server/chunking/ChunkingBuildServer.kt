package org.jetbrains.plugins.bsp.server.chunking
...
class ChunkingBuildServer<S : JoinedBuildServer>(private val base: S, private val minChunkSize: Int) : JoinedBuildServer by base {
