...
import org.jetbrains.plugins.bsp.server.chunking.ChunkingBuildServer
...
import org.jetbrains.plugins.bsp.server.utils.CancellableFuture
import org.jetbrains.plugins.bsp.server.utils.TimeoutHandler
import org.jetbrains.plugins.bsp.server.utils.reactToExceptionIn
import org.jetbrains.plugins.bsp.sync.status.SyncStatusListener
import org.jetbrains.plugins.bsp.ui.console.BspConsoleService
import org.jetbrains.plugins.bsp.ui.console.TaskConsole
import org.jetbrains.plugins.bsp.ui.console.ids.CONNECT_TASK_ID
...
class DefaultBspConnection(
  ...
  private suspend fun ensureConnected() {
    ...
    val inMemoryConnection = object : GenericConnection {
