...
@ApiStatus.Internal
object OutputLocationParserWithoutHardlink {
  /**
   * Use [OutputLocationParser.parseExecrootPath] instead. This method is only intended to be used in unit tests.
   */
  ...
  /**
   * Use [OutputLocationParser.parse] instead. This method is only intended to be used in unit tests.
   */
