...
""",
    ...
    attrs = {
        ...
        "_uploader": attr.label(
            executable = True,
            cfg = "host",
            default = "@rules_sonatype//src/main/kotlin/org/jetbrains/bazel/sonatype:SonatypePublisher",
            allow_files = True,
        ),
        "_rules_jvm_external_uploader": attr.label(
            executable = True,
            cfg = "host",
            default = "@rules_sonatype//src/main/java/org/jetbrains/bazel:MavenPublisher",
            allow_files = True,
        ),
    },
)
