...
object LegacyBridgeJpsEntitySourceFactory {
  fun createEntitySourceForModule(
    ...
    return PlatformLegacyBridgeJpsEntitySourceFactory.getInstance(project).createEntitySourceForModule(
      baseModuleDir,
      externalSource
    )
  }
  ...
  fun createEntitySourceForProjectLibrary(
    ...
    return PlatformLegacyBridgeJpsEntitySourceFactory.getInstance(project).createEntitySourceForProjectLibrary(
      externalSource,
    )
  }
}
