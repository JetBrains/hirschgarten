...
object LegacyBridgeJpsEntitySourceFactory {
  fun createEntitySourceForModule(
    ...
    return PlatformLegacyBridgeJpsEntitySourceFactory.createEntitySourceForModule(
      project,
      baseModuleDir,
      externalSource,
  ...
  fun createEntitySourceForProjectLibrary(
    ...
    return PlatformLegacyBridgeJpsEntitySourceFactory.createEntitySourceForProjectLibrary(
      project,
      externalSource,
      fileInDirectoryNames,
      fileName,
