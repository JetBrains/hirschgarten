...
public class LabelTest {
  ...
  public void testGetPackage_nonEmpty() {
    Truth.assertThat(Label.of("//package/path:rule").getPackage())
        .isEqualTo(Path.of("package/path"));
  }

  @Test
  public void testGetPackage_withWorkspace() {
    Truth.assertThat(Label.of("@myws//package/path:rule").getPackage())
        .isEqualTo(Path.of("package/path"));
  }
  ...
  public void testGetName_simple() {
    Truth.assertThat(Label.of("//package/path:rule").getName()).isEqualTo(Path.of("rule"));
  }

  @Test
  public void testGetName_withWorkspace() {
    Truth.assertThat(Label.of("@someworkspace//package/path:rule").getName())
        .isEqualTo(Path.of("rule"));
  }

  @Test
  public void testGetPackage_empty() {
    Truth.assertThat(Label.of("//:rule").getPackage()).isEqualTo(Path.of(""));
  }

  @Test
  public void testGetPackage_empty_withWorkspace() {
    Truth.assertThat(Label.of("@workspace//:rule").getPackage()).isEqualTo(Path.of(""));
  }

  @Test
  public void testGetName_withDirectory() {
    Truth.assertThat(Label.of("//package/path:source/Class.java").getName())
        .isEqualTo(Path.of("source/Class.java"));
  }

  @Test
  public void testGetName_emptyPackage() {
    Truth.assertThat(Label.of("//:rule").getName()).isEqualTo(Path.of("rule"));
  }

  @Test
  public void testGetName_emptyPackage_withWorkspace() {
    Truth.assertThat(Label.of("@foo//:rule").getName()).isEqualTo(Path.of("rule"));
  }
  ...
  public void testToFilePath() {
    Truth.assertThat(Label.of("//package/path:BUILD").toFilePath())
