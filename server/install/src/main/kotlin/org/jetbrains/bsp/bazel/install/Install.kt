...
object Install {
  ...
  private fun runInstall(cliOptions: CliOptions) {
    try {
      ...
      System.err.print(
          "Bazel BSP server installation failed! Reason: ${e.stackTrace.joinToString("\n")}")
      exitProcess(1)
    }
  }
  ...
  private fun createBspConnectionDetails(
      ...
      createTraceLog: Boolean
  ): BspConnectionDetails {
    val bspConnectionDetailsCreator =
        BspConnectionDetailsCreator(installationContext, createTraceLog)
