...
class CliOptionsProviderTest {
  ...
  inner class WorkspaceRootDirTest {
    ...
    fun `should return success and absolute path to provided workspace root dir if relative specified`() {
      ...
      val expectedWorkspaceRootDir =
          Paths.get("").toAbsolutePath().parent.parent.resolve("path/to/dir")
      cliOptions.workspaceRootDir shouldBe expectedWorkspaceRootDir
      cliOptions.workspaceRootDir.isAbsolute shouldBe true
    }
  }
  ...
  inner class ProjectViewFilePathTest {
    ...
    fun `should return success and absolute path to provided project view file if not absolute specified`() {
      ...
      val expectedProjectViewFilePath =
          Paths.get("path/to/projectview.bazelproject").toAbsolutePath()
      cliOptions.projectViewFilePath shouldBe expectedProjectViewFilePath
      cliOptions.projectViewFilePath?.isAbsolute shouldBe true
    }
    ...
    fun `should return success and absolute path to provided project view file if relative specified`() {
      ...
      val expectedProjectViewFilePath =
          Paths.get("").toAbsolutePath().parent.parent.resolve("path/to/projectview.bazelproject")
      cliOptions.projectViewFilePath shouldBe expectedProjectViewFilePath
      cliOptions.projectViewFilePath?.isAbsolute shouldBe true
    }
  }
  ...
  inner class ProjectViewCliOptionsTest {
    ...
    inner class JavaPathTest {
      ...
      fun `should return success and absolute path to provided java file if relative specified`() {
        ...
        // then
        val expectedJavaPath = Paths.get("").toAbsolutePath().parent.parent.resolve("path/to/java")
        cliOptions.javaPath shouldBe expectedJavaPath
        cliOptions.javaPath?.isAbsolute shouldBe true
      }
    }
    ...
    inner class BazelBinaryTest {
      ...
      fun `should return success and absolute path to provided java file if relative specified`() {
        ...
        // then
        val expectedBazelBinary =
            Paths.get("").toAbsolutePath().parent.parent.resolve("path/to/bazel")
        cliOptions.projectViewCliOptions?.bazelBinary shouldBe expectedBazelBinary
        cliOptions.projectViewCliOptions?.bazelBinary?.isAbsolute shouldBe true
      }
    }
    ...
    inner class BuildFlagsTest {
      ...
      fun `should return success if build flags are specified`() {
        // given
        val args =
            arrayOf("-f", "--build_flag1=value1", "--build_flag1=value2", "--build_flag1=value3")
        ...
        // then
        val expectedBuildFlags =
            listOf("--build_flag1=value1", "--build_flag1=value2", "--build_flag1=value3")
