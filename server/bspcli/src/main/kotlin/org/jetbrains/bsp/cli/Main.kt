...
data class Args(val workspace: Path, val metricsFile: Path?, val target: String)
...
fun parseArgs(args: Array<String>): Args {
  ...
  println(
      "Invalid number of arguments. Just pass path to your workspace as a CLI argument to this app")
  exitProcess(1)
}
...
fun main(args0: Array<String>) {
  ...
  val connection =
      Connection(installationDirectory, args.metricsFile, args.workspace, BuildClient())
