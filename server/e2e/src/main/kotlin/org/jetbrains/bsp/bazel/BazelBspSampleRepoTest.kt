...
object BazelBspSampleRepoTest : BazelBspTestBaseScenario() {
  ...
  @JvmStatic fun main(args: Array<String>) = executeScenario()
  ...
  private fun resolveProject(): BazelBspTestScenarioStep =
      BazelBspTestScenarioStep("resolve project") { testClient.testResolveProject(2.minutes) }

  private fun compareWorkspaceTargetsResults(): BazelBspTestScenarioStep =
      BazelBspTestScenarioStep("compare workspace targets results") {
  ...
  private fun sourcesResults(): BazelBspTestScenarioStep {
    ...
    val scalaTargetsScalaBinaryScala =
        SourceItem("file://\$WORKSPACE/scala_targets/ScalaBinary.scala", SourceItemKind.FILE, false)
    ...
    val scalaTargetsScalaTestScala =
        SourceItem("file://\$WORKSPACE/scala_targets/ScalaTest.scala", SourceItemKind.FILE, false)
    ...
    val javaTargetsJavaBinaryJava =
        SourceItem("file://\$WORKSPACE/java_targets/JavaBinary.java", SourceItemKind.FILE, false)
    ...
    val javaTargetsJavaLibraryJava =
        SourceItem("file://\$WORKSPACE/java_targets/JavaLibrary.java", SourceItemKind.FILE, false)
    ...
    val manualTargetTestJavaFile =
        SourceItem("file://\$WORKSPACE/manual_target/TestJavaFile.java", SourceItemKind.FILE, false)
    ...
    val manualTargetTestScalaTest =
        SourceItem("file://\$WORKSPACE/manual_target/ScalaTest.scala", SourceItemKind.FILE, false)
    ...
    val environmentVariablesJavaBinary =
        SourceItem(
            "file://\$WORKSPACE/environment_variables/JavaEnv.java", SourceItemKind.FILE, false)
    ...
    val environmentVariablesJavaTest =
        SourceItem(
            "file://\$WORKSPACE/environment_variables/JavaTest.java", SourceItemKind.FILE, false)
  ...
  private fun resourcesResults(): BazelBspTestScenarioStep {
    ...
    return BazelBspTestScenarioStep("resources results") {
  ...
  private fun inverseSourcesResults(): BazelBspTestScenarioStep {
    val inverseSourcesDocument =
        TextDocumentIdentifier("file://\$WORKSPACE/java_targets/JavaBinary.java")
    val expectedInverseSourcesResult =
        InverseSourcesResult(
            listOf(BuildTargetIdentifier("$targetPrefix//java_targets:java_binary")))
    val inverseSourcesParams = InverseSourcesParams(inverseSourcesDocument)
    return BazelBspTestScenarioStep("inverse sources results") {
      testClient.testInverseSources(30.seconds, inverseSourcesParams, expectedInverseSourcesResult)
    }
  }
  ...
  private fun scalaMainClasses(): BazelBspTestScenarioStep {
    ...
    val scalaTargetsScalaBinary =
        ScalaMainClassesItem(
            BuildTargetIdentifier("$targetPrefix//scala_targets:scala_binary"),
            listOf(
                ScalaMainClass("example.Example", listOf("arg1", "arg2"), listOf("-Xms2G -Xmx5G"))))
    val targetWithoutJvmFlagsBinary =
        ScalaMainClassesItem(
            BuildTargetIdentifier("$targetPrefix//target_without_jvm_flags:binary"),
    ...
    val targetWithoutArgsBinary =
        ScalaMainClassesItem(
            BuildTargetIdentifier("$targetPrefix//target_without_args:binary"),
            listOf(ScalaMainClass("example.Example", emptyList(), listOf("-Xms2G -Xmx5G"))))
    ...
    val expectedScalaMainClassesResult =
        ScalaMainClassesResult(
            listOf(
                ...
                targetWithoutArgsBinary,
                manualTargetScalaBinary))
    return BazelBspTestScenarioStep("Scala main classes") {
  ...
  private fun scalaTestClasses(): BazelBspTestScenarioStep {
    ...
    val expectedScalaTestClassesResult =
        ScalaTestClassesResult(listOf(scalaTargetsScalaTest, manualTargetScalaTest))
    return BazelBspTestScenarioStep("Scala test classes") {
  ...
  private fun dependencySourcesResults(): BazelBspTestScenarioStep {
    ...
    val targetWithDependencyJavaBinary =
        DependencySourcesItem(
            BuildTargetIdentifier("$targetPrefix//target_with_dependency:java_binary"),
            listOf("file://\$BAZEL_OUTPUT_BASE_PATH/external/guava/guava-28.0-jre-src.jar"))
    val javaTargetsSubpackageJavaLibrary =
        DependencySourcesItem(
            BuildTargetIdentifier("$targetPrefix//java_targets/subpackage:java_library"),
            emptyList())
    ...
    return BazelBspTestScenarioStep("dependency sources results") {
      testClient.testDependencySources(30.seconds, dependencySourcesParams, expectedDependencies)
    }
  }
            ...
            listOf(
                ...
                JvmEnvironmentItem(
                        BuildTargetIdentifier(
                            "$targetPrefix//java_targets/subpackage:java_library"),
                        listOf(),
                        emptyList(),
                        "\$WORKSPACE",
                        mapOf())
                ...
                JvmEnvironmentItem(
                        ...
                        "\$WORKSPACE",
                        mapOf())
                    .apply { mainClasses = listOf(JvmMainClass("example.Example", emptyList())) },
                JvmEnvironmentItem(
                        BuildTargetIdentifier("$targetPrefix//target_without_jvm_flags:binary"),
                        listOf(
                            "file://\$BAZEL_OUTPUT_BASE_PATH/external/io_bazel_rules_scala_scala_library/scala-library-2.12.14.jar",
                ...
                JvmEnvironmentItem(
                        ...
                        "\$WORKSPACE",
                        mapOf(
                            "foo1" to "val1", "foo2" to "val2", "foo3" to "val3", "foo4" to "val4"))
                    .apply { mainClasses = emptyList() },
                JvmEnvironmentItem(
                        BuildTargetIdentifier("$targetPrefix//manual_target:scala_test"),
                        listOf(
                ...
                JvmEnvironmentItem(
                    ...
                    .apply {
                      mainClasses =
                          listOf(JvmMainClass("manual_target.TestScalaBinary", emptyList()))
                    },
                JvmEnvironmentItem(
                        BuildTargetIdentifier("$targetPrefix//manual_target:java_test"),
                        listOf(
                ...
                JvmEnvironmentItem(
                    ...
                    .apply {
                      mainClasses =
                          listOf(JvmMainClass("manual_target.TestJavaBinary", emptyList()))
                    }))
    return BazelBspTestScenarioStep("jvm run environment results") {
  ...
  private fun jvmTestEnvironment(): BazelBspTestScenarioStep {
    ...
    return BazelBspTestScenarioStep("jvm test environment results") {
  ...
  override fun expectedWorkspaceBuildTargetsResult(): WorkspaceBuildTargetsResult {
    ...
    javaTargetsSubpackageSubpackage.displayName =
        "$targetPrefix//java_targets/subpackage:java_library"
