...
object BazelBspPythonProjectTest : BazelBspTestBaseScenario() {
  ...
  override fun expectedWorkspaceBuildTargetsResult(): WorkspaceBuildTargetsResult {
    val examplePythonBuildTarget =
        PythonBuildTarget().also {
          it.version = "PY3"
          it.interpreter =
              "file://\$BAZEL_OUTPUT_BASE_PATH/external/python3_9_x86_64-unknown-linux-gnu/bin/python3"
        }
  ...
  private fun pythonOptionsResults(): BazelBspTestScenarioStep {
    ...
    val expectedPythonOptionsItems =
        expectedTargetIdentifiers.map { PythonOptionsItem(it, emptyList()) }
    ...
    return BazelBspTestScenarioStep("pythonOptions results") {
