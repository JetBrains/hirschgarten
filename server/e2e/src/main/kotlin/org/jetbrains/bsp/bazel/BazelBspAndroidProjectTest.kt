...
object BazelBspAndroidProjectTest : BazelBspAndroidProjectTestBase() {
  ...
  override fun expectedWorkspaceBuildTargetsResult(): WorkspaceBuildTargetsResult {
    ...
    val androidJar =
        "file://\$BAZEL_OUTPUT_BASE_PATH/external/androidsdk/platforms/android-34/android.jar"
    ...
    val libAndroidBuildTargetData =
        AndroidBuildTarget(
            ...
            resourceDirectories =
                listOf("file://\$WORKSPACE/src/main/java/com/example/myapplication/res/"),
            resourceJavaPackage = null,
            assetsDirectories = emptyList(),
            jvmBuildTarget = jvmBuildTargetData,
        )
    ...
    val libTestAndroidBuildTargetData =
        AndroidBuildTarget(
            ...
            manifest =
                "file://\$WORKSPACE/src/test/java/com/example/myapplication/AndroidManifest.xml",
            resourceDirectories = emptyList(),
            resourceJavaPackage = null,
            assetsDirectories = emptyList(),
            jvmBuildTarget = jvmBuildTargetData,
        ...
        BuildTarget(
            ...
            listOf(
                BuildTargetIdentifier(
                    "@@rules_jvm_external~~maven~maven//:androidx_appcompat_appcompat")),
            BuildTargetCapabilities().apply {
              canCompile = true
              canDebug = false
              canRun = false
    ...
    val libTestBuildTarget =
        BuildTarget(
            ...
            listOf(
                ...
                BuildTargetIdentifier(
                    "@@rules_jvm_external~~maven~maven//:org_robolectric_robolectric"),
                BuildTargetIdentifier(
                    "@@rules_jvm_external~~maven~maven//:org_robolectric_shadows_framework"),
