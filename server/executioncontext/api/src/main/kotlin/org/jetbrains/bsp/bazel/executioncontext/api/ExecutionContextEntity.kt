...
/**
 * Base `ExecutionContext` entity class - you need to extend it or `ExecutionContextListEntity` or
 * `ExecutionContextSingletonEntity` if you want to create your entity.
 *
...
/**
 * Base list-based `ExecutionContext` entity class - you need to extend it if you want to create
 * your list-based entity.
 */
...
/**
 * Base list-based `ExecutionContext` entity class - you need to extend it if you want to create
 * your list-based with excluded values entity.
 */
...
/**
 * Base single-value `ExecutionContext` entity class - you need to extend it if you want to create
 * your single-value entity.
 */
...
/**
 * Maps `ProjectView` into `ExecutionContextEntity`. It takes entire `ProjectView` because sometimes
 * in order to create one `ExecutionContextEntity` you may want to use multiple `ProjectView`
 * sections.
 *
