...
abstract class ProjectViewExcludableListSectionGenerator<
    V, in T : ProjectViewExcludableListSection<V>> : ProjectViewListSectionGenerator<V, T>() {

  /**
   * Returns pretty representation of an excludable list section, it means that the format looks
   * like that:
   *
   * <section name>: <included value 1> (4 leading spaces) <included value 2> <included value 3> ...
   * <excluded value 1> <excluded value 2> ...
   */
  ...
  private fun generatePrettyStringForExcludedValueWithFourLeadingSpacesAndExcludeSign(
      value: V
  ): String = "    -${generatePrettyStringForValue(value)}"
}
