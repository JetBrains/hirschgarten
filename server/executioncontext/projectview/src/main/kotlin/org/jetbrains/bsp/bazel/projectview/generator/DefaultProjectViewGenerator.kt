...
object DefaultProjectViewGenerator : ProjectViewGenerator {
  ...
  override fun generatePrettyString(projectView: ProjectView): String =
      listOfNotNull(
              ...
              ProjectViewBuildManualTargetsSectionGenerator.generatePrettyString(
                  projectView.buildManualTargets),
              ProjectViewDirectoriesSectionGenerator.generatePrettyString(projectView.directories),
              ProjectViewDeriveTargetsFromDirectoriesSectionGenerator.generatePrettyString(
              ...
              ProjectViewEnabledRulesSectionGenerator.generatePrettyString(
