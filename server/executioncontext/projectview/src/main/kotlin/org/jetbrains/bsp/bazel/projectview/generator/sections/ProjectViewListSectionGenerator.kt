...
abstract class ProjectViewListSectionGenerator<V, in T : ProjectViewListSection<V>> :
   ...
   *
   * <section name>: <value 1> (4 leading spaces) <value 2> <value 3> ...
   */
  override fun generatePrettyStringForNonNull(section: T): String {
    val valuesPrettyStringRepresentation =
        generatePrettyStringForValues(
            section.values, ::generatePrettyStringForValueWithFourLeadingSpaces)

    return listOfNotNull("${section.sectionName}:", valuesPrettyStringRepresentation)
        .joinToString(separator = "\n")
  }

  protected fun generatePrettyStringForValues(
      values: List<V>,
...
object ProjectViewBuildFlagsSectionGenerator :
    ProjectViewListSectionGenerator<String, ProjectViewBuildFlagsSection>()

object ProjectViewEnabledRulesSectionGenerator :
    ProjectViewListSectionGenerator<String, ProjectViewEnabledRulesSection>()
