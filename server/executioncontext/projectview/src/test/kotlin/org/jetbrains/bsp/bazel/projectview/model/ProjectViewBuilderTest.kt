          ...
          ProjectView.Builder(
                  ...
                  directories =
                      ProjectViewDirectoriesSection(
                          listOf(Path("included_dir1"), Path("included_dir2")),
                          listOf(Path("excluded_dir1"))),
                  deriveTargetsFromDirectories =
                      ProjectViewDeriveTargetsFromDirectoriesSection(true),
    ...
    fun `should return current singleton values and combined list values`() {
      ...
      val importedProjectViewTry =
          ProjectView.Builder(
                  ...
                  directories =
                      ProjectViewDirectoriesSection(
                          listOf(Path("included_dir1.1"), Path("included_dir1.2")),
                          listOf(Path("excluded_dir1.1"))),
                  deriveTargetsFromDirectories =
                      ProjectViewDeriveTargetsFromDirectoriesSection(false),
      ...
      val projectView =
          ProjectView.Builder(
                  ...
                  directories =
                      ProjectViewDirectoriesSection(
                          listOf(Path("included_dir2.1"), Path("included_dir2.2")),
    ...
    fun `should return last singleton values and combined list values for three imports`() {
      ...
      val importedProjectViewTry3 =
          ProjectView.Builder(
                  ...
                  directories =
                      ProjectViewDirectoriesSection(
                          listOf(Path("included_dir3.1"), Path("included_dir3.2")),
                          listOf(Path("excluded_dir3.1"))),
                  deriveTargetsFromDirectories =
                      ProjectViewDeriveTargetsFromDirectoriesSection(false),
      ...
      val projectView =
          ProjectView.Builder(
                  ...
                  directories =
                      ProjectViewDirectoriesSection(
                          listOf(Path("included_dir4.1"), Path("included_dir4.2")),
                          listOf(Path("excluded_dir4.1"))),
                  deriveTargetsFromDirectories =
                      ProjectViewDeriveTargetsFromDirectoriesSection(true),
              )
              .build()
