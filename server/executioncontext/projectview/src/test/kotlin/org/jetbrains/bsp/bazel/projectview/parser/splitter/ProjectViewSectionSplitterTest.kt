...
class ProjectViewSectionSplitterTest {
  ...
  fun `should return empty section`() {
    ...
    // then
    val expectedSections = ProjectViewRawSections(listOf(ProjectViewRawSection("section", "   ")))
    sections shouldBe expectedSections
  }
  ...
  fun `should return section (import) with no colon`() {
    ...
    val expectedSections =
        ProjectViewRawSections(
            listOf(ProjectViewRawSection("import", "path/to/file.bazelproject\n")))
    sections shouldBe expectedSections
  }
  ...
  fun `should return section with single element`() {
    ...
    // then
    val expectedSection =
        ProjectViewRawSections(listOf(ProjectViewRawSection("section", " section_element\n")))
  ...
  fun `should return section with single element with dots and colon`() {
    ...
    // then
    val expectedSection =
        ProjectViewRawSections(listOf(ProjectViewRawSection("section", " 1.2.3.4:8080\n")))
    sections shouldBe expectedSection
  }
