  ...
  internal inner class ParseProjectViewFilePathTest {
    ...
    fun `should return empty derive_targets_from_directories section for file without derive_targets_from_directories section`() {
      ...
      val projectViewFilePath =
          Path("/projectview/without/derive_targets_from_directories.bazelproject")
          ...
          ProjectView(
              ...
              directories =
                  ProjectViewDirectoriesSection(
                      ...
                      listOf(Path("excluded_dir1.1"), Path("excluded_dir4.1"))),
              deriveTargetsFromDirectories = ProjectViewDeriveTargetsFromDirectoriesSection(true),
              importDepth = ProjectViewImportDepthSection(1),
              enabledRules = null,
              ideJavaHomeOverride = null,
    ...
    fun `should parse file with empty imported file`() {
      ...
      val expectedProjectView =
          ProjectView(
              targets =
                  ProjectViewTargetsSection(
                      listOf(BuildTargetIdentifier("//included_target8.1")),
                      listOf(
              ...
              directories =
                  ProjectViewDirectoriesSection(
                      listOf(Path("included_dir8.1"), Path("included_dir8.2")),
                      listOf(
          ...
          ProjectView(
              ...
              enabledRules =
                  ProjectViewEnabledRulesSection(
                      listOf("io_bazel_rules_scala", "rules_jvm", "rules_java")),
              ideJavaHomeOverride = null,
          )
