...
class DefaultProjectViewGeneratorTest {
          ...
          ProjectView(
              ...
              directories =
                  ProjectViewDirectoriesSection(
                      listOf(Path("included_dir1"), Path("included_dir2"), Path("included_dir3")),
                      listOf(Path("excluded_dir1"), Path("excluded_dir2"))),
              deriveTargetsFromDirectories = null,
              importDepth = null,
              enabledRules = null,
              ideJavaHomeOverride = null,
  ...
  @Nested
  @DisplayName(
      "fun generatePrettyStringAndSaveInFile(projectView: ProjectView, filePath: Path): Unit tests")
