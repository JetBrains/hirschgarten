...
class ProjectViewSingletonSectionParserTest<V, T : ProjectViewSingletonSection<V>> {
  companion object {
    ...
    fun data(): List<Arguments> =
        listOf(bazelBinarySectionArguments(), buildManualTargetsSectionArguments())
    ...
    private fun buildManualTargetsSectionArguments(): Arguments {
      ...
      val sectionConstructor =
          createSectionConstructor(
              rawValueConstructor,
              { value: Boolean -> ProjectViewBuildManualTargetsSection(value) },
  ...
  internal inner class ParseRawSectionTest {
    ...
    fun shouldReturnSectionWithTrimmedValue(
      ...
      // given
      val rawSection = ProjectViewRawSection(sectionName, "  ${rawValueConstructor("value")}\t\n")
  ...
  internal inner class ParseRawSectionsTest {
    ...
    fun shouldReturnLastSectionWithoutExplicitDefault(
      ...
      val rawSection2 = ProjectViewRawSection(sectionName, "  ${rawValueConstructor("value2")}\t\n")
      val rawSection3 = ProjectViewRawSection("another_section2", "\tvalue3\n")
      val rawSection4 = ProjectViewRawSection(sectionName, "  ${rawValueConstructor("value4")}\n")
