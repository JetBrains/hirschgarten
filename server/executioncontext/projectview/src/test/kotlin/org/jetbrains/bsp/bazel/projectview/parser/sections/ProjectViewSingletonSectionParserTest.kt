...
class ProjectViewSingletonSectionParserTest<V, T : ProjectViewSingletonSection<V>> {
  companion object {
    ...
    ): (String) -> T = { seed: String -> sectionMapper(elementMapper(rawValueConstructor(seed))) }
  }
