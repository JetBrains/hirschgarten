...
data class BuildManualTargetsSpec(override val value: Boolean) :
    ExecutionContextSingletonEntity<Boolean>()

private val defaultBuildManualTargetsSpec = BuildManualTargetsSpec(value = false)

internal object BuildManualTargetsSpecExtractor :
    ExecutionContextEntityExtractor<BuildManualTargetsSpec> {
  ...
  private fun map(
      buildManualTargetsSection: ProjectViewBuildManualTargetsSection
  ): BuildManualTargetsSpec = BuildManualTargetsSpec(buildManualTargetsSection.value)
}
