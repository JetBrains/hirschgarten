...
internal class DotBazelBspDirPathSpecExtractor(private val workspaceRoot: Path) : ExecutionContextEntityExtractor<DotBazelBspDirPathSpec> {
  ...
  private fun calculatePathToDotBazelBspDir(): Path = workspaceRoot.toAbsolutePath().normalize().resolve(".bazelbsp")
}
