...
private constructor(
  ...
  fun runBazelCommandBes(
    ...
    return runBazelCommand(
        command, flags = besFlags() + flags, arguments, environment, originId, true)
  }
  ...
  fun runBazelCommand(
    ...
    return BazelProcess(process, outputLogger)
  }
  ...
  private fun bazel(workspaceContext: WorkspaceContext): String =
      workspaceContext.bazelBinary.value.toString()
