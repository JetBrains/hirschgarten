...
class BazelRunnerBuildBuilder(bazelRunner: BazelRunner, bazelBuildCommand: List<String>) :
  BazelRunnerBuilder(bazelRunner, bazelBuildCommand) {
  override fun withTargets(bazelTargets: List<String>): BazelRunnerBuilder = withArguments(bazelTargets)
