...
object BazelFlag {
  ...
  @JvmStatic
  fun buildEventBinaryPathConversion(enabled: Boolean): String =
  ...
  @JvmStatic
  fun repositoryOverride(repositoryName: String, path: String): String =
  ...
  @JvmStatic
  fun experimentalEnableAndroidMigrationApis(): String =
