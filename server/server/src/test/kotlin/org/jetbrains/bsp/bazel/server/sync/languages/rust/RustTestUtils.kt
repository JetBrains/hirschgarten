...
fun createTarget(moduleName: String, directDependencies: List<String>): Module {
  ...
  return createModule(
    ...
    sources = setOf(URI.create(crateRoot).toSourceWithData()),
    baseDirectory = URI.create("$pathPrefix/dir$moduleName/"),
  )
}

@TestOnly
fun URI.toSourceWithData() = SourceWithData(this)
...
fun getModuleWithoutDependencies(features: List<String> = emptyList()): Pair<RustModule, Module> {
  ...
  val module =
    createModule(
      ...
      sources =
        setOf(
          URI.create("file:///path/to/sample_target/src/lib.rs").toSourceWithData(),
        ),
...
fun getModulesWithDependency(): List<Module> {
  ...
  val moduleA =
    createModule(
      label = "@//dirA:targetA",
      directDependencies = emptyList(),
      sources = setOf(URI.create("file:///path/to/dirA/src/lib.rs").toSourceWithData()),
  ...
  val moduleB =
    createModule(
      ...
      sources = setOf(URI.create("file:///path/to/dirB/src/lib.rs").toSourceWithData()),
