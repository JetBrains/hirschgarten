...
object DependencyMapper {
  ...
  fun extractMavenDependencyInfo(lib: Library): MavenDependencyModule? {
    ...
    val jars = lib.outputs.map { uri -> uri.toString() }.map { MavenDependencyModuleArtifact(it) }
    val sourceJars =
        lib.sources
    ...
    // string such as
    // .../execroot/monorepo/bazel-out/k8-fastbuild/bin/external/maven/com/google/guava/guava/31.1-jre/processed_guava-31.1-jre.jar
