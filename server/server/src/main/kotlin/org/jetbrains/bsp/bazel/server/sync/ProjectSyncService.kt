...
class ProjectSyncService(
  ...
  private fun setupTelemetry(initializeBuildParams: InitializeBuildParams) {
    ...
    val telemetryConfigWithHttp =
        telemetryConfig.copy(openTelemetryEndpoint = openTelemetryEndpoint)
